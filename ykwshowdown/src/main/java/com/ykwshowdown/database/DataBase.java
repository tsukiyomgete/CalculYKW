...
public class DataBase {
    ...
    try (PreparedStatement uS = getConnection().prepareStatement(sql)) {
        ...
        uS.setString(5, y.getTalent());
        uS.setString(6, y.GetWkElementString());
        uS.setDouble(7, y.getWeakMultipliers());
        uS.setString(8, y.GetResElementString());
        uS.setDouble(9, y.getResMultipliers());
        uS.setString(10, y.GetTierString());
        uS.setInt(11, y.getStatAId());
        uS.setInt(12, y.getStatBId());
        uS.setInt(13, y.getAttack().getId());
        uS.setInt(14, y.GetTechnique().getId());
        uS.setString(15, y.getInspirit().getNom());
        uS.setDouble(16, y.getBaseAttackPerC());
        uS.setDouble(17, y.getBaseTechniquePerC());
        uS.setDouble(18, y.getBaseInspiritPerC());
        uS.setDouble(19, y.getBaseGuardPerC());
        uS.setDouble(20, y.getChanceInspirited());
        uS.setInt(21, y.getMaxItem());
        uS.executeUpdate();
    }
}
