...
*/
	...
	{
		try {
			DataBase.insertTechnique(technique);
		}catch(SQLException e){
			System.out.println("Erreur de connexion à la base de données : " + e.getMessage());
		}
	}
	...
	{
		try {
			DataBase.insertAttack(atk);
		}catch(SQLException e){
			System.out.println("Erreur de connexion à la base de données : " + e.getMessage());
		}
	}

	public static void insererTalent(Talent tal)
	{
		try {
			DataBase.insertTalent(tal);
		}catch(SQLException e){
			System.out.println("Erreur de connexion à la base de données : " + e.getMessage());
		}
	}
	...
	public static Elemental Lightning = new Elemental("Lightning");
    ...
    new Technique(10, "Lightning", 50, 110, 1, Lightning),
	...
	new PhysicalAttack(31,"Pointy Pokes",12,26,3,Neutral),
	new PhysicalAttack(32,"Power Punch",50,110,1,Neutral),
	new PhysicalAttack(33,"Practiced Pur",90,135,1,Neutral),
	new PhysicalAttack(34,"Punch",15,67,1,Neutral),
	new PhysicalAttack(35,"Rocket Punch",100,150,1,Neutral),
	new PhysicalAttack(36,"Sharp Claws",10,45,2,Neutral),
	new PhysicalAttack(37,"Shoot",10,45,1,Neutral),
	new PhysicalAttack(38,"Slap",10,45,1,Neutral),
	new PhysicalAttack(39,"Slurp",50,110,1,Neutral),
	new PhysicalAttack(40,"Smack Down",20,44,2,Neutral),
	new PhysicalAttack(41,"Spraygun",100,150,1,Neutral),
	new PhysicalAttack(42,"Squish",10,45,1,Neutral),
	new PhysicalAttack(43,"Stab Storm",10,22,5,Neutral),
	new PhysicalAttack(44,"Steamroll",60,90,1,Neutral),
	new PhysicalAttack(45,"Stepping Slice",15,67,1,Neutral),
	new PhysicalAttack(46,"Tackle",60,90,1,Neutral),
	new PhysicalAttack(47,"Tail Slap",100,150,1,Neutral),
	new PhysicalAttack(48,"Ventilator",50,110,1,Neutral),
};

	public static void insererLesAttacks()
	{
		for(int i=0; i<ListAttack.length; i++)
		{
			insererAttack(ListAttack[i]);
		}
	}
...
private static Inspirit[] mergeInspirits(Inspirit[]... arrays) {
	int total = 0;
	for (Inspirit[] a : arrays) total += a.length;
	Inspirit[] result = new Inspirit[total];
	int i = 0;
	for (Inspirit[] a : arrays) for (Inspirit s : a) result[i++] = s;
	return result;
}
	...
	{
		try {
			DataBase.insertInspirit(inspirit);
		} catch(SQLException e){
			System.out.println("Erreur de connexion à la base de données : " + e.getMessage());
		}
	}

	public static void insererLesInspirits()
	{
		for(int i=0; i<inspiritList.length; i++)
		{
			insererInspirit(inspiritList[i]);
		}
	}
...
private static Stat[] statA_0() {
	return new Stat[] {
		...
		new Stat(34,10,5,6,8), // #17 Slicenrice (Bony Spirits)(Rare)
		new Stat(38,23,22,19,21), // #18 Flamurice (Fleshy Souls)
		new Stat(38,23,22,19,21), // #18 Flamurice (Bony Spirits)(Rare)
		...
		new Stat(41,14,10,13,12), // #35 Beetler (Fleshy Souls)(Rare)
		new Stat(49,22,16,21,18), // #36 Beetall (Bony Spirits)
		new Stat(49,22,16,21,18), // #36 Beetall (Fleshy Souls)(Rare)
		...
		new Stat(36,6,4,8,3), // #92 Noway (Fleshy Souls)(Rare)
		new Stat(49,19,15,22,17), // #93 Impass (Bony Spirits)
		new Stat(49,19,15,22,17), // #93 Impass (Fleshy Souls)(Rare)
...
private static Stat[] statA_1() {
	return new Stat[] {
		...
		new Stat(48,10,8,11,7), // #114 Rhinoggin (Bony Spirits)(Rare)
		new Stat(56,15,11,17,14), // #115 Rhinormous (Fleshy Souls)
		new Stat(56,15,11,17,14), // #115 Rhinormous (Bony Spirits)(Rare)
		...
		new Stat(28,7,9,6,10), // #130 Pupsicle (Bony Spirits)(Rare)
		new Stat(37,22,23,20,21), // #131 Chilhuahua (Fleshy Souls)
		new Stat(37,22,23,20,21), // #131 Chilhuahua (Bony Spirits)(Rare)
		...
		new Stat(36,8,13,8,11), // #139 Walkappa (Fleshy Souls)(Rare)
		new Stat(40,12,15,9,11), // #140 Appak (Bony Spirits)
		new Stat(40,12,15,9,11), // #140 Appak (Fleshy Souls)(Rare)
		...
		new Stat(32,5,8,7,9), // #167 Hungramps (Bony Spirits)(Rare)
		new Stat(45,15,17,14,16), // #168 Hungorge (Fleshy Souls)
		new Stat(45,15,17,14,16), // #168 Hungorge (Bony Spirits)(Rare)
		...
		new Stat(29,10,5,6,7), // #172 Sandmeh (Fleshy Souls)(Rare)
		new Stat(42,16,14,12,13), // #173 Mr. Sandmeh (Bony Spirits)
		new Stat(42,16,14,12,13), // #173 Mr. Sandmeh (Fleshy Souls)(Rare)
...
private static Stat[] statA_2() {
	return new Stat[] {
		...
		new Stat(34,11,9,8,12), // #214 Dimmy (Fleshy Souls)(Rare)
		new Stat(39,22,21,18,23), // #215 Blandon (Bony Spirits)
		new Stat(39,22,21,18,23), // #215 Blandon (Fleshy Souls)(Rare)
		new Stat(53,10,11,9,11), // #216 Nul
		new Stat(37,11,12,10,13), // #217 Suspicioni (Bony Spirits)
		new Stat(37,11,12,10,13), // #217 Suspicioni (Fleshy Souls)(Rare)
		...
		new Stat(34,7,9,13,8), // #253 Rockabelly (Bony Spirits)(Rare)
		...
		new Stat(36,17,13,14,16), // #267 Nagatha (Bony Spirits)(Rare)
...
public static Stat[] statA = mergeStats(statA_0(), statA_1(), statA_2(), statA_3(), statA_4());
...
private static Stat[] statB_0() {
	return new Stat[] {
		...
		new Stat(320,171,83,98,142), // #17 Slicenrice (Bony Spirits)(Rare)
		new Stat(351,195,186,127,156), // #18 Flamurice (Fleshy Souls)
		new Stat(351,195,186,127,156), // #18 Flamurice (Bony Spirits)(Rare)
		...
		new Stat(361,180,103,167,146), // #35 Beetler (Fleshy Souls)(Rare)
		new Stat(426,215,106,195,148), // #36 Beetall (Bony Spirits)
		new Stat(426,215,106,195,148), // #36 Beetall (Fleshy Souls)(Rare)
		...
		new Stat(338,122,66,168,65), // #92 Noway (Fleshy Souls)(Rare)
		new Stat(419,169,89,217,121), // #93 Impass (Bony Spirits)
		new Stat(419,169,89,217,121), // #93 Impass (Fleshy Souls)(Rare)
...
private static Stat[] statB_1() {
	return new Stat[] {
		...
		new Stat(402,163,105,182,102), // #114 Rhinoggin (Bony Spirits)(Rare)
		new Stat(429,184,107,210,155), // #115 Rhinormous (Fleshy Souls)
		new Stat(429,184,107,210,155), // #115 Rhinormous (Bony Spirits)(Rare)
		...
		new Stat(271,118,128,91,135), // #130 Pupsicle (Bony Spirits)(Rare)
		new Stat(343,167,203,136,163), // #131 Chilhuahua (Fleshy Souls)
		new Stat(343,167,203,136,163), // #131 Chilhuahua (Bony Spirits)(Rare)
		...
		new Stat(305,98,157,108,151), // #139 Walkappa (Fleshy Souls)(Rare)
		new Stat(368,176,179,119,162), // #140 Appak (Bony Spirits)
		new Stat(368,176,179,119,162), // #140 Appak (Fleshy Souls)(Rare)
		...
		new Stat(276,128,131,125,153), // #144 Komajiro (Bony Spirits)(Rare)
		new Stat(355,174,170,151,162), // #145 Komiger (Fleshy Souls)
		new Stat(355,174,170,151,162), // #145 Komiger (Bony Spirits)(Rare)
		...
		new Stat(298,130,175,129,173), // #148 Whapir (Fleshy Souls)(Rare)
		...
		new Stat(300,85,133,108,142), // #167 Hungramps (Bony Spirits)(Rare)
		new Stat(368,136,184,132,155), // #168 Hungorge (Fleshy Souls)
		new Stat(368,136,184,132,155), // #168 Hungorge (Bony Spirits)(Rare)
		...
		new Stat(273,147,100,102,136), // #172 Sandmeh (Fleshy Souls)(Rare)
		new Stat(357,165,153,138,153), // #173 Mr. Sandmeh (Bony Spirits)
		new Stat(357,165,153,138,153), // #173 Mr. Sandmeh (Fleshy Souls)(Rare)
...
private static Stat[] statB_2() {
	return new Stat[] {
		...
		new Stat(286,139,103,75,156), // #214 Dimmy (Fleshy Souls)(Rare)
		new Stat(349,186,154,90,191), // #215 Blandon (Bony Spirits)
		new Stat(349,186,154,90,191), // #215 Blandon (Fleshy Souls)(Rare)
		new Stat(361,161,183,134,186), // #216 Nul
		new Stat(288,126,149,123,133), // #217 Suspicioni (Bony Spirits)
		new Stat(288,126,149,123,133), // #217 Suspicioni (Fleshy Souls)(Rare)
		...
		new Stat(310,96,140,147,123), // #253 Rockabelly (Bony Spirits)(Rare)
		...
		new Stat(342,180,98,128,150), // #267 Nagatha (Bony Spirits)(Rare)
...
public static Stat[] statB = mergeStats(statB_0(), statB_1(), statB_2(), statB_3(), statB_4());
...
private static Yokai[] medaillum_0() {
	return new Yokai[] {
		...
		new Yokai("Slicenrice (Fleshy Souls)", 17, D, Brave, false, statA[16], statB[16], ListAttack[8], ListTechnique[7], "Rice and Dice", inspiritList[14], Ice, 1.3, Fire, 0.7, 0.65, 0.15, 0.1, 0.1, 0.75, 1),
		new Yokai("Slicenrice (Bony Spirits)(Rare)", 17, D, Brave, false, statA[17], statB[17], ListAttack[8], ListTechnique[7], "Bear Care", inspiritList[14], Ice, 1.3, Fire, 0.7, 0.65, 0.15, 0.1, 0.1, 0.75, 1),
		new Yokai("Flamurice (Fleshy Souls)", 18, A, Brave, false, statA[18], statB[18], ListAttack[20], ListTechnique[1], "Rice and Dice", inspiritList[15], Water, 1.8, Fire, 0.3, 0.65, 0.25, 0.05, 0.05, 0.85, 1),
		new Yokai("Flamurice (Bony Spirits)(Rare)", 18, A, Brave, false, statA[19], statB[19], ListAttack[20], ListTechnique[1], "Firewall", inspiritList[15], Water, 1.8, Fire, 0.3, 0.65, 0.25, 0.05, 0.05, 0.85, 1),
		new Yokai("Helmsman", 19, D, Brave, false, statA[20], statB[20], ListAttack[15], ListTechnique[17], "Spirit Guard", inspiritList[16], Earth, 1.3, Thunder, 0.7, 0.6, 0.2, 0.1, 0.1, 0.75, 1),
		new Yokai("Reuknight", 20, A, Brave, false, statA[21], statB[21], ListAttack[41], ListTechnique[9], "Spirit Guard", inspiritList[17], Earth, 1.5, Thunder, 0.5, 0.65, 0.15, 0.1, 0.1, 0.85, 1),
		new Yokai("Corptain", 21, S, Brave, false, statA[22], statB[22], ListAttack[41], ListTechnique[3], "Spirit Guard", inspiritList[18], Water, 1.5, Fire, 0.5, 0.65, 0.15, 0.15, 0.05, 0.9, 1),
		new Yokai("Mudmunch", 22, C, Brave, false, statA[23], statB[23], ListAttack[30], ListTechnique[16], "Sludge Grudge", inspiritList[19], Wind, 1.5, Earth, 0.5, 0.6, 0.15, 0.15, 0.1, 0.75, 1),
		new Yokai("Sgt. Burly", 23, C, Brave, false, statA[24], statB[24], ListAttack[30], ListTechnique[9], "Gimme Twenty", inspiritList[20], Earth, 1.5, Thunder, 0.5, 0.8, 0.1, 0.05, 0.05, 0.75, 1),
		new Yokai("Blazion", 24, C, Brave, false, statA[25], statB[25], ListAttack[31], ListTechnique[1], "Blazing Spirit", inspiritList[21], Water, 1.8, Fire, 0.3, 0.5, 0.35, 0.1, 0.05, 0.75, 1),
		new Yokai("Quaken", 25, B, Brave, false, statA[26], statB[26], ListAttack[31], ListTechnique[16], "Courageous Spirit", inspiritList[22], Water, 1.8, Earth, 0.3, 0.5, 0.35, 0.1, 0.05, 0.8, 1),
		new Yokai("Siro", 26, A, Brave, false, statA[27], statB[27], ListAttack[31], ListTechnique[9], "Shining Spirit", inspiritList[23], Earth, 1.8, Thunder, 0.5, 0.45, 0.4, 0.1, 0.05, 0.85, 1),
		new Yokai("Chansin", 27, C, Brave, false, statA[28], statB[28], ListAttack[25], ListTechnique[4], "Gambler", inspiritList[24], Water, 1.3, Fire, 0.7, 0.6, 0.2, 0.15, 0.05, 0.75, 1),
		new Yokai("Sheen", 28, A, Brave, false, statA[29], statB[29], ListAttack[20], ListTechnique[23], "Light Speed", inspiritList[25], Ice, 1.5, Wind, 0.5, 0.7, 0.15, 0.1, 0.05, 0.85, 1),
		new Yokai("Snee", 29, A, Brave, false, statA[30], statB[30], ListAttack[20], ListTechnique[0], "Cursed Skin", inspiritList[26], Thunder, 1.5, Ice, 0.5, 0.5, 0.25, 0.2, 0.05, 0.85, 1),
		new Yokai("Gleam", 30, S, Brave, false, statA[31], statB[31], ListAttack[20], ListTechnique[17], "Light Speed", inspiritList[27], Earth, 1.8, Thunder, 0.5, 0.75, 0.1, 0.1, 0.05, 0.9, 1),
		new Yokai("Benkei", 31, C, Brave, false, statA[32], statB[32], ListAttack[20], ListTechnique[6], "Sword Hunting", inspiritList[28], Fire, 1.8, Ice, 0.5, 0.7, 0.1, 0.15, 0.05, 0.75, 1),
		new Yokai("B3-NK1", 32, B, Brave, false, statA[33], statB[33], ListAttack[20], ListTechnique[17], "Sword Hunting", inspiritList[29], Earth, 1.8, Thunder, 0.5, 0.75, 0.1, 0.1, 0.05, 0.8, 1),
		new Yokai("Sushiyama", 33, B, Brave, false, statA[34], statB[34], ListAttack[14], ListTechnique[5], "Guard Break", inspiritList[30], Fire, 1.5, Ice, 0.5, 0.55, 0.25, 0.15, 0.05, 0.8, 1),
		new Yokai("Kapunki", 34, A, Brave, false, statA[35], statB[35], ListAttack[14], ListTechnique[1], "The Stand", inspiritList[31], Earth, 1.3, Thunder, 0.7, 0.5, 0.35, 0.1, 0.05, 0.85, 1),
		new Yokai("Beetler (Bony Spirits)", 35, B, Brave, false, statA[36], statB[36], ListAttack[25], ListTechnique[12], "Too Serious", inspiritList[32], Wind, 1.5, Earth, 0.7, 0.65, 0.15, 0.1, 0.1, 0.8, 1),
		new Yokai("Beetler (Fleshy Souls)(Rare)", 35, B, Brave, false, statA[37], statB[37], ListAttack[25], ListTechnique[12], "Lone Soldier", inspiritList[32], Wind, 1.5, Earth, 0.7, 0.65, 0.15, 0.1, 0.1, 0.8, 1),
		new Yokai("Beetall (Bony Spirits)", 36, S, Brave, false, statA[38], statB[38], ListAttack[22], ListTechnique[5], "Intimidation", inspiritList[33], Fire, 1.5, Earth, 0.5, 0.75, 0.1, 0.05, 0.1, 0.9, 1),
		new Yokai("Beetall (Fleshy Souls)(Rare)", 36, S, Brave, false, statA[39], statB[39], ListAttack[22], ListTechnique[5], "Lone Soldier", inspiritList[33], Fire, 1.5, Earth, 0.5, 0.75, 0.1, 0.05, 0.1, 0.9, 1),
		new Yokai("Cruncha", 37, S, Brave, false, statA[40], statB[40], ListAttack[22], ListTechnique[9], "Intimidation", inspiritList[34], Ice, 1.8, Thunder, 0.5, 0.7, 0.1, 0.1, 0.1, 0.9, 1),
		new Yokai("Demuncher", 38, S, Brave, false, statA[41], statB[41], ListAttack[21], ListTechnique[16], "Sneaky Snacker", inspiritList[35], Wind, 1.8, Earth, 0.3, 0.7, 0.15, 0.1, 0.05, 0.9, 1),
		new Yokai("Devourer", 39, S, Brave, false, statA[42], statB[42], ListAttack[21], ListTechnique[14], "Soul Snacker", inspiritList[36], Fire, 1.8, Water, 0.2, 0.65, 0.2, 0.1, 0.05, 0.9, 1),
		new Yokai("Brokenbrella", 40, E, Mysterious, false, statA[43], statB[43], ListAttack[3], ListTechnique[23], "Gust o' Gusto", inspiritList[37], Ice, 1.5, Wind, 0.5, 0.2, 0.65, 0.1, 0.05, 0.7, 1),
		new Yokai("Pittapatt", 41, E, Mysterious, false, statA[44], statB[44], ListAttack[3], ListTechnique[12], "Got Your Back", inspiritList[38], Wind, 1.3, Earth, 0.7, 0.15, 0.55, 0.2, 0.1, 0.7, 1),
		new Yokai("Snotsolong", 42, E, Mysterious, false, statA[45], statB[45], ListAttack[27], ListTechnique[20], "Water Play", inspiritList[39], Thunder, 1.5, Water, 0.5, 0.1, 0.6, 0.25, 0.05, 0.7, 2),
		new Yokai("Duchoo", 43, D, Mysterious, false, statA[46], statB[46], ListAttack[27], ListTechnique[5], "Snow Play", inspiritList[40], Fire, 2.0, Water, 0.5, 0.05, 0.7, 0.2, 0.05, 0.7, 2),
		new Yokai("D'wanna", 44, E, Mysterious, false, statA[47], statB[47], ListAttack[17], ListTechnique[7], "Soothing Rhythm", inspiritList[41], Earth, 1.3, Thunder, 0.7, 0.15, 0.6, 0.2, 0.05, 0.7, 1),
		new Yokai("N'more", 45, C, Mysterious, false, statA[48], statB[48], ListAttack[1], ListTechnique[15], "Soothing Rhythm", inspiritList[41], Earth, 1.3, Thunder, 0.7, 0.15, 0.6, 0.2, 0.05, 0.75, 1),
		new Yokai("Q'wit", 46, C, Mysterious, false, statA[49], statB[49], ListAttack[1], ListTechnique[16], "Soothing Rhythm", inspiritList[42], Wind, 1.5, Earth, 0.5, 0.2, 0.55, 0.2, 0.05, 0.75, 1),
		new Yokai("Wazzat", 47, E, Mysterious, false, statA[50], statB[50], ListAttack[2], ListTechnique[23], "Forgot to Guard", inspiritList[43], Ice, 1.5, Wind, 0.5, 0.1, 0.55, 0.3, 0.05, 0.7, 1),
		new Yokai("Houzzat", 48, B, Mysterious, false, statA[51], statB[51], ListAttack[6], ListTechnique[19], "Forgot to Guard", inspiritList[44], Ice, 1.8, Wind, 0.3, 0.05, 0.6, 0.25, 0.1, 0.75, 1),
		new Yokai("Dummkap", 49, E, Mysterious, false, statA[52], statB[52], ListAttack[2], ListTechnique[17], "Prediction", inspiritList[45], Earth, 1.5, Thunder, 0.7, 0.05, 0.6, 0.3, 0.05, 0.7, 2),
		new Yokai("Faysoff", 50, D, Mysterious, false, statA[53], statB[53], ListAttack[16], ListTechnique[20], "Bony Bond", inspiritList[46], Thunder, 1.3, Water, 0.7, 0.1, 0.6, 0.25, 0.05, 0.7, 2),
		new Yokai("Lafalotta", 51, D, Mysterious, false, statA[54], statB[54], ListAttack[16], ListTechnique[0], "Hanging In", inspiritList[47], Wind, 1.3, Earth, 0.7, 0.15, 0.6, 0.2, 0.05, 0.7, 1),
		new Yokai("Blips", 52, C, Mysterious, false, statA[55], statB[55], ListAttack[16], ListTechnique[3], "Hanging In", inspiritList[48], Wind, 1.3, Earth, 0.7, 0.15, 0.6, 0.2, 0.05, 0.75, 1),
		new Yokai("Tattletell", 53, D, Mysterious, false, statA[56], statB[56], ListAttack[36], ListTechnique[15], "Caring", inspiritList[49], Fire, 1.3, Ice, 0.7, 0.1, 0.7, 0.15, 0.05, 0.7, 1),
		new Yokai("Tattlecast", 54, B, Mysterious, false, statA[57], statB[57], ListAttack[1], ListTechnique[11], "Caring", inspiritList[49], Fire, 1.5, Ice, 0.5, 0.1, 0.75, 0.1, 0.05, 0.75, 1),
		new Yokai("Skranny", 55, C, Mysterious, false, statA[58], statB[58], ListAttack[36], ListTechnique[15], "Caring", inspiritList[50], Thunder, 1.3, Earth, 0.7, 0.1, 0.6, 0.25, 0.05, 0.75, 1),
		new Yokai("Cupistol", 56, D, Mysterious, false, statA[59], statB[59], ListAttack[35], ListTechnique[23], "Popularity", inspiritList[51], Ice, 1.3, Wind, 0.7, 0.15, 0.6, 0.2, 0.05, 0.7, 1),
		new Yokai("Casanuva", 57, A, Mysterious, false, statA[60], statB[60], ListAttack[13], ListTechnique[18], "Popularity", inspiritList[51], Ice, 1.5, Wind, 0.5, 0.15, 0.6, 0.2, 0.05, 0.8, 1),
		new Yokai("Casanono", 58, A, Mysterious, false, statA[61], statB[61], ListAttack[13], ListTechnique[1], "Unpopularity", inspiritList[52], Water, 1.5, Fire, 0.7, 0.1, 0.65, 0.2, 0.05, 0.8, 1),
		new Yokai("So-Sorree", 59, D, Mysterious, false, statA[62], statB[62], ListAttack[36], ListTechnique[17], "Make Amends", inspiritList[53], Earth, 1.3, Thunder, 0.5, 0.1, 0.6, 0.25, 0.05, 0.7, 1),
		new Yokai("Bowminos", 60, A, Mysterious, false, statA[63], statB[63], ListAttack[10], ListTechnique[10], "Make Amends", inspiritList[53], Water, 1.3, Earth, 0.5, 0.05, 0.6, 0.2, 0.15, 0.8, 1),
		new Yokai("Smogling", 61, D, Mysterious, false, statA[64], statB[64], ListAttack[3], ListTechnique[23], "Magic Mist", inspiritList[54], Ice, 1.5, Wind, 0.5, 0.1, 0.65, 0.2, 0.05, 0.7, 1),
		new Yokai("Smogmella", 62, A, Mysterious, false, statA[65], statB[65], ListAttack[38], ListTechnique[18], "Magic Mist", inspiritList[54], Ice, 1.8, Wind, 0.3, 0.05, 0.7, 0.2, 0.05, 0.8, 1),
		new Yokai("Signibble", 63, D, Mysterious, false, statA[66], statB[66], ListAttack[25], ListTechnique[9], "Lightning Play", inspiritList[55], Earth, 1.5, Thunder, 0.5, 0.15, 0.65, 0.15, 0.05, 0.7, 1),
		new Yokai("Signiton", 64, A, Mysterious, false, statA[67], statB[67], ListAttack[25], ListTechnique[21], "Lightning Play", inspiritList[55], Earth, 1.8, Thunder, 0.3, 0.3, 0.55, 0.1, 0.05, 0.8, 1),
		new Yokai("Statiking", 65, S, Mysterious, false, statA[68], statB[68], ListAttack[25], ListTechnique[21], "Long Lasting", inspiritList[56], Earth, 2.0, Thunder, 0.2, 0.25, 0.6, 0.1, 0.05, 0.85, 1),
		new Yokai("Master Oden", 66, A, Mysterious, false, statA[69], statB[69], ListAttack[1], ListTechnique[21], "Tasty Aroma", inspiritList[57], Earth, 1.8, Thunder, 0.2, 0.25, 0.6, 0.05, 0.1, 0.8, 1),
		new Yokai("Failian", 67, C, Mysterious, false, statA[70], statB[70], ListAttack[3], ListTechnique[2], "Electro Field", inspiritList[58], Fire, 1.5, Ice, 0.5, 0.2, 0.55, 0.15, 0.1, 0.75, 1),
		new Yokai("Apelican", 68, C, Mysterious, false, statA[71], statB[71], ListAttack[25], ListTechnique[19], "Number One!", inspiritList[59], Ice, 1.5, Wind, 0.5, 0.2, 0.65, 0.1, 0.05, 0.75, 2),
		new Yokai("Mirapo", 69, C, Mysterious, false, statA[72], statB[72], ListAttack[3], ListTechnique[3], "Mirror Body", inspiritList[60], Earth, 1.3, Thunder, 0.7, 0.1, 0.5, 0.3, 0.1, 0.75, 1),
		new Yokai("Miradox", 70, A, Mysterious, false, statA[73], statB[73], ListAttack[44], ListTechnique[14], "Mirror Body", inspiritList[60], Earth, 1.5, Thunder, 0.5, 0.05, 0.55, 0.25, 0.15, 0.8, 1),
		new Yokai("Mircle", 71, A, Mysterious, false, statA[74], statB[74], ListAttack[3], ListTechnique[14], "Mirror Body", inspiritList[61], Earth, 1.5, Thunder, 0.5, 0.1, 0.5, 0.3, 0.1, 0.8, 1),
		new Yokai("Illoo", 72, C, Mysterious, false, statA[75], statB[75], ListAttack[17], ListTechnique[13], "Brother's Vow", inspiritList[62], Thunder, 1.3, Earth, 0.7, 0.1, 0.7, 0.15, 0.05, 0.75, 1),
		new Yokai("Elloo", 73, C, Mysterious, false, statA[76], statB[76], ListAttack[17], ListTechnique[5], "Brother's Vow", inspiritList[63], Thunder, 1.3, Water, 0.7, 0.05, 0.7, 0.2, 0.05, 0.75, 1),
		new Yokai("Alloo", 74, B, Mysterious, false, statA[77], statB[77], ListAttack[17], ListTechnique[9], "Brother's Vow", inspiritList[64], Earth, 1.3, Thunder, 0.7, 0.15, 0.7, 0.1, 0.05, 0.75, 1),
		new Yokai("Espy", 75, B, Mysterious, false, statA[78], statB[78], ListAttack[16], ListTechnique[16], "Hanging In", inspiritList[65], Wind, 1.3, Earth, 0.7, 0.15, 0.6, 0.2, 0.05, 0.75, 1),
		new Yokai("Infour", 76, B, Mysterious, false, statA[79], statB[79], ListAttack[16], ListTechnique[3], "Hanging In", inspiritList[66], Earth, 1.3, Ice, 0.7, 0.1, 0.7, 0.15, 0.05, 0.75, 1),
		new Yokai("Verygoodsir", 77, B, Mysterious, false, statA[80], statB[80], ListAttack[38], ListTechnique[15], "Caring", inspiritList[67], Earth, 1.5, Fire, 0.5, 0.1, 0.6, 0.25, 0.05, 0.75, 1),
		new Yokai("Tengu", 78, S, Mysterious, false, statA[81], statB[81], ListAttack[23], ListTechnique[18], "Wind Play", inspiritList[68], Ice, 1.8, Wind, 0.3, 0.1, 0.7, 0.15, 0.05, 0.85, 1),
		new Yokai("Flengu", 79, S, Mysterious, false, statA[82], statB[82], ListAttack[23], ListTechnique[8], "Fire Play", inspiritList[69], Water, 2.0, Earth, 0.7, 0.15, 0.7, 0.1, 0.05, 0.85, 1),
		new Yokai("Kyubi", 80, S, Mysterious, false, statA[83], statB[83], ListAttack[45], ListTechnique[8], "Penetrate", inspiritList[69], Water, 1.8, Fire, 0.5, 0.1, 0.75, 0.1, 0.05, 0.85, 1),
		new Yokai("Frostail", 81, S, Mysterious, false, statA[84], statB[84], ListAttack[45], ListTechnique[2], "Sense of Smell", inspiritList[70], Fire, 1.8, Water, 0.7, 0.1, 0.7, 0.15, 0.05, 0.85, 1),
		new Yokai("Chymera", 82, S, Mysterious, false, statA[85], statB[85], ListAttack[6], ListTechnique[21], "In a Flash", inspiritList[71], Earth, 1.5, Thunder, 0.5, 0.2, 0.65, 0.1, 0.05, 0.85, 1),
		new Yokai("Kingmera", 83, S, Mysterious, false, statA[86], statB[86], ListAttack[6], ListTechnique[21], "In a Flash", inspiritList[72], Earth, 1.5, Thunder, 0.3, 0.2, 0.65, 0.1, 0.05, 0.85, 1),
		new Yokai("Terrorpotta", 84, E, Tough, false, statA[87], statB[87], ListAttack[3], ListTechnique[12], "Rest in Pieces", inspiritList[73], Wind, 1.5, Earth, 0.5, 0.4, 0.05, 0.35, 0.2, 0.7, 2),
		new Yokai("Dulluma", 85, E, Tough, false, statA[88], statB[88], ListAttack[3], ListTechnique[12], "Glossy Skin", inspiritList[74], Fire, 1.3, Earth, 0.7, 0.55, 0.2, 0.15, 0.1, 0.7, 1),
		new Yokai("Darumacho", 86, B, Tough, false, statA[89], statB[89], ListAttack[30], ListTechnique[12], "Glossy Skin", inspiritList[75], Fire, 1.5, Earth, 0.5, 0.7, 0.1, 0.1, 0.1, 0.85, 1),
		new Yokai("Goruma", 87, B, Tough, false, statA[90], statB[90], ListAttack[30], ListTechnique[23], "Glossy Skin", inspiritList[76], Thunder, 1.8, Earth, 0.7, 0.75, 0.05, 0.1, 0.1, 0.85, 1),
		new Yokai("Wotchagot", 88, E, Tough, false, statA[91], statB[91], ListAttack[3], ListTechnique[6], "Bitter Rice", inspiritList[77], Fire, 1.5, Ice, 0.5, 0.1, 0.45, 0.3, 0.15, 0.7, 1),
		new Yokai("Pride Shrimp", 89, B, Tough, false, statA[92], statB[92], ListAttack[44], ListTechnique[15], "Thick Crust", inspiritList[78], Fire, 1.8, Ice, 0.3, 0.05, 0.5, 0.2, 0.25, 0.85, 1),
		new Yokai("No-Go Kart", 90, E, Tough, false, statA[93], statB[93], ListAttack[3], ListTechnique[12], "Digging In", inspiritList[79], Wind, 1.5, Earth, 0.5, 0.45, 0.1, 0.3, 0.15, 0.7, 1),
		new Yokai("Mistank", 91, B, Tough, false, statA[94], statB[94], ListAttack[18], ListTechnique[16], "Earth Cannon", inspiritList[80], Wind, 1.8, Earth, 0.3, 0.5, 0.05, 0.2, 0.25, 0.85, 1),
		new Yokai("Noway (Bony Spirits)", 92, E, Tough, false, statA[95], statB[95], ListAttack[3], ListTechnique[12], "Blocker", inspiritList[81], Water, 1.5, Earth, 0.5, 0.6, 0.1, 0.05, 0.25, 0.7, 1),
		new Yokai("Noway (Fleshy Souls)(Rare)", 92, E, Tough, false, statA[96], statB[96], ListAttack[3], ListTechnique[12], "Endurance", inspiritList[81], Water, 1.5, Earth, 0.5, 0.6, 0.1, 0.05, 0.25, 0.7, 1),
		new Yokai("Impass (Bony Spirits)", 93, A, Tough, false, statA[97], statB[97], ListAttack[44], ListTechnique[16], "Blocker", inspiritList[81], Water, 1.8, Earth, 0.3, 0.55, 0.1, 0.05, 0.3, 0.85, 1),
		new Yokai("Impass (Fleshy Souls)(Rare)", 93, A, Tough, false, statA[98], statB[98], ListAttack[44], ListTechnique[16], "Rocky Terrain", inspiritList[81], Water, 1.8, Earth, 0.3, 0.55, 0.1, 0.05, 0.3, 0.85, 1),
		new Yokai("Walldin", 94, A, Tough, false, statA[99], statB[99], ListAttack[44], ListTechnique[16], "Blocker", inspiritList[82], Ice, 1.5, Earth, 0.3, 0.5, 0.1, 0.05, 0.35, 0.85, 1),
	};
}

private static Yokai[] medaillum_1() {
	return new Yokai[] {
		new Yokai("Roughraff", 95, E, Tough, false, statA[100], statB[100], ListAttack[15], ListTechnique[12], "Revenge", inspiritList[83], Water, 1.3, Earth, 0.7, 0.7, 0.1, 0.1, 0.1, 0.7, 1),
		new Yokai("Badude", 96, B, Tough, false, statA[101], statB[101], ListAttack[14], ListTechnique[16], "Revenge", inspiritList[83], Water, 1.3, Earth, 0.5, 0.75, 0.05, 0.1, 0.1, 0.85, 1),
		new Yokai("Bruff", 97, A, Tough, false, statA[102], statB[102], ListAttack[14], ListTechnique[10], "Revenge", inspiritList[84], Wind, 2.0, Earth, 0.3, 0.75, 0.05, 0.1, 0.1, 0.85, 1),
		new Yokai("Armsman", 98, D, Tough, false, statA[103], statB[103], ListAttack[30], ListTechnique[6], "Spirit Guard", inspiritList[85], Earth, 1.5, Thunder, 0.5, 0.6, 0.15, 0.1, 0.15, 0.75, 1),
		new Yokai("Mimikin", 99, D, Tough, false, statA[104], statB[104], ListAttack[32], ListTechnique[5], "Me Too!", inspiritList[86], Fire, 1.5, Ice, 0.5, 0.4, 0.05, 0.35, 0.2, 0.75, 1),
		new Yokai("Blowkade", 100, D, Tough, false, statA[105], statB[105], ListAttack[26], ListTechnique[20], "The Stand", inspiritList[87], Thunder, 1.5, Water, 0.5, 0.6, 0.1, 0.15, 0.15, 0.75, 1),
		new Yokai("Ledballoon", 101, C, Tough, false, statA[106], statB[106], ListAttack[26], ListTechnique[20], "The Stand", inspiritList[88], Thunder, 1.5, Water, 0.5, 0.55, 0.15, 0.15, 0.15, 0.8, 1),
		new Yokai("Fidgephant", 102, D, Tough, false, statA[107], statB[107], ListAttack[12], ListTechnique[20], "Endurance", inspiritList[89], Thunder, 1.3, Earth, 0.7, 0.5, 0.3, 0.1, 0.1, 0.75, 1),
		new Yokai("Touphant", 103, C, Tough, false, statA[108], statB[108], ListAttack[12], ListTechnique[13], "Endurance", inspiritList[90], Thunder, 1.3, Water, 0.7, 0.3, 0.5, 0.1, 0.1, 0.8, 1),
		new Yokai("Enduriphant", 104, A, Tough, false, statA[109], statB[109], ListAttack[46], ListTechnique[13], "Going Nowhere", inspiritList[91], Thunder, 1.5, Water, 0.5, 0.45, 0.3, 0.1, 0.15, 0.85, 1),
		new Yokai("Zappary", 105, D, Tough, false, statA[110], statB[110], ListAttack[27], ListTechnique[9], "In a Flash", inspiritList[92], Earth, 1.5, Thunder, 0.5, 0.4, 0.45, 0.05, 0.1, 0.75, 1),
		new Yokai("Frazzel", 106, A, Tough, false, statA[111], statB[111], ListAttack[28], ListTechnique[21], "Superconductor", inspiritList[92], Earth, 1.8, Thunder, 0.3, 0.3, 0.55, 0.05, 0.1, 0.85, 1),
		new Yokai("Swelton", 107, C, Tough, false, statA[112], statB[112], ListAttack[40], ListTechnique[1], "Oily Mess", inspiritList[93], Water, 1.5, Fire, 0.5, 0.1, 0.35, 0.35, 0.2, 0.8, 2),
		new Yokai("Mad Mountain", 108, C, Tough, false, statA[113], statB[113], ListAttack[26], ListTechnique[6], "The Stand", inspiritList[94], Fire, 1.5, Earth, 0.5, 0.55, 0.1, 0.15, 0.2, 0.8, 1),
		new Yokai("Castelius III", 110, C, Tough, false, statA[114], statB[114], ListAttack[3], ListTechnique[12], "Bronze Guard", inspiritList[96], Thunder, 1.5, Earth, 0.5, 0.55, 0.1, 0.2, 0.15, 0.8, 1),
		new Yokai("Castelius II", 111, B, Tough, false, statA[115], statB[115], ListAttack[44], ListTechnique[5], "Silver Guard", inspiritList[97], Fire, 1.5, Earth, 0.5, 0.55, 0.1, 0.2, 0.15, 0.85, 1),
		new Yokai("Castelius I", 112, A, Tough, false, statA[116], statB[116], ListAttack[4], ListTechnique[9], "Gold Guard", inspiritList[98], Earth, 1.5, Thunder, 0.5, 0.55, 0.1, 0.15, 0.2, 0.85, 1),
		new Yokai("Castelius Max", 113, S, Tough, false, statA[117], statB[117], ListAttack[4], ListTechnique[19], "Platinum Guard", inspiritList[99], Thunder, 1.5, Earth, 0.5, 0.55, 0.1, 0.1, 0.25, 0.9, 1),
		new Yokai("Rhinoggin (Fleshy Souls)", 114, B, Tough, false, statA[118], statB[118], ListAttack[12], ListTechnique[16], "Guard Break", inspiritList[100], Fire, 1.3, Earth, 0.7, 0.6, 0.15, 0.15, 0.1, 0.85, 1),
		new Yokai("Rhinoggin (Bony Spirits)(Rare)", 114, B, Tough, false, statA[119], statB[119], ListAttack[12], ListTechnique[16], "Lone Soldier", inspiritList[100], Fire, 1.3, Earth, 0.7, 0.6, 0.15, 0.15, 0.1, 0.85, 1),
		new Yokai("Rhinormous (Fleshy Souls)", 115, S, Tough, false, statA[120], statB[120], ListAttack[14], ListTechnique[16], "Guard Break", inspiritList[101], Fire, 1.3, Earth, 0.7, 0.6, 0.1, 0.1, 0.2, 0.9, 1),
		new Yokai("Rhinormous (Bony Spirits)(Rare)", 115, S, Tough, false, statA[121], statB[121], ListAttack[14], ListTechnique[16], "Lone Soldier", inspiritList[101], Fire, 1.3, Earth, 0.7, 0.6, 0.1, 0.1, 0.2, 0.9, 1),
		new Yokai("Hornaplenty", 116, S, Tough, false, statA[122], statB[122], ListAttack[14], ListTechnique[10], "Guard Break", inspiritList[34], Thunder, 1.3, Earth, 0.5, 0.7, 0.05, 0.1, 0.15, 0.9, 1),
		new Yokai("Robonyan", 117, A, Tough, false, statA[123], statB[123], ListAttack[33], ListTechnique[5], "Blocker", inspiritList[102], Thunder, 1.5, Earth, 0.5, 0.55, 0.2, 0.15, 0.1, 0.85, 1),
		new Yokai("Goldenyan", 118, S, Tough, false, statA[124], statB[124], ListAttack[33], ListTechnique[9], "Gold Guard", inspiritList[103], Earth, 1.5, Thunder, 0.3, 0.65, 0.1, 0.15, 0.1, 0.9, 1),
		new Yokai("Dromp", 119, A, Tough, false, statA[125], statB[125], ListAttack[42], ListTechnique[16], "Insulator", inspiritList[104], Fire, 1.8, Earth, 0.3, 0.55, 0.1, 0.1, 0.25, 0.85, 1),
		new Yokai("Swosh", 120, S, Tough, false, statA[126], statB[126], ListAttack[42], ListTechnique[22], "Blessed Body", inspiritList[105], Thunder, 2.0, Water, 0.3, 0.1, 0.55, 0.1, 0.25, 0.9, 1),
		new Yokai("Toadal Dude", 121, S, Tough, false, statA[127], statB[127], ListAttack[7], ListTechnique[22], "Toadally Saved", inspiritList[106], Thunder, 1.8, Water, 0.3, 0.65, 0.15, 0.1, 0.1, 0.9, 1),
		new Yokai("Uber Geeko", 122, S, Tough, false, statA[128], statB[128], ListAttack[7], ListTechnique[8], "Geckstra Safe", inspiritList[107], Water, 1.8, Fire, 0.2, 0.15, 0.65, 0.1, 0.1, 0.9, 1),
		new Yokai("Leggly", 123, E, Charming, false, statA[129], statB[129], ListAttack[19], ListTechnique[7], "Great Legs", inspiritList[108], Water, 1.5, Wind, 0.5, 0.6, 0.15, 0.2, 0.05, 0.65, 2),
		new Yokai("Dazzabel", 124, E, Charming, false, statA[130], statB[130], ListAttack[27], ListTechnique[4], "Hanging In", inspiritList[109], Water, 1.3, Fire, 0.7, 0.5, 0.3, 0.15, 0.05, 0.65, 1),
		new Yokai("Rattelle", 125, C, Charming, false, statA[131], statB[131], ListAttack[41], ListTechnique[1], "Hanging In", inspiritList[110], Water, 1.5, Fire, 0.5, 0.65, 0.2, 0.1, 0.05, 0.75, 1),
		new Yokai("Skelebella", 126, B, Charming, false, statA[132], statB[132], ListAttack[29], ListTechnique[13], "Hanging In", inspiritList[110], Thunder, 1.8, Water, 0.5, 0.65, 0.15, 0.15, 0.05, 0.8, 1),
		new Yokai("Cadin", 127, E, Charming, false, statA[133], statB[133], ListAttack[43], ListTechnique[23], "Modest", inspiritList[111], Fire, 1.3, Earth, 0.7, 0.55, 0.3, 0.1, 0.05, 0.65, 1),
		new Yokai("Cadable", 128, C, Charming, false, statA[134], statB[134], ListAttack[8], ListTechnique[19], "Modest", inspiritList[111], Fire, 1.5, Earth, 0.5, 0.65, 0.2, 0.1, 0.05, 0.75, 1),
		new Yokai("Singcada", 129, B, Charming, false, statA[135], statB[135], ListAttack[8], ListTechnique[1], "Eyesight A", inspiritList[112], Water, 1.8, Earth, 0.5, 0.6, 0.25, 0.1, 0.05, 0.8, 1),
		new Yokai("Pupsicle (Fleshy Souls)", 130, E, Charming, false, statA[136], statB[136], ListAttack[2], ListTechnique[5], "Penetrate", inspiritList[113], Fire, 1.5, Ice, 0.5, 0.2, 0.55, 0.15, 0.1, 0.65, 1),
		new Yokai("Pupsicle (Bony Spirits)(Rare)", 130, E, Charming, false, statA[137], statB[137], ListAttack[2], ListTechnique[5], "Fangsicles", inspiritList[113], Fire, 1.5, Ice, 0.5, 0.2, 0.55, 0.15, 0.1, 0.65, 1),
		new Yokai("Chilhuahua (Fleshy Souls)", 131, A, Charming, false, statA[138], statB[138], ListAttack[46], ListTechnique[2], "Penetrate", inspiritList[114], Fire, 1.8, Ice, 0.3, 0.25, 0.6, 0.1, 0.05, 0.8, 1),
		new Yokai("Chilhuahua (Bony Spirits)(Rare)", 131, A, Charming, false, statA[139], statB[139], ListAttack[46], ListTechnique[2], "Alpine Wall", inspiritList[114], Fire, 1.8, Ice, 0.3, 0.25, 0.6, 0.1, 0.05, 0.8, 1),
		new Yokai("Swelterrier", 132, S, Charming, false, statA[140], statB[140], ListAttack[46], ListTechnique[8], "Fire Watchout", inspiritList[115], Water, 1.8, Fire, 0.5, 0.35, 0.5, 0.1, 0.05, 0.85, 1),
		new Yokai("Jumbelina", 133, D, Charming, false, statA[141], statB[141], ListAttack[36], ListTechnique[5], "Shuffle", inspiritList[116], Fire, 1.3, Ice, 0.7, 0.1, 0.5, 0.35, 0.05, 0.7, 1),
		new Yokai("Boyclops", 134, D, Charming, false, statA[142], statB[142], ListAttack[16], ListTechnique[5], "Soulful Promise", inspiritList[117], Fire, 1.3, Ice, 0.7, 0.5, 0.1, 0.35, 0.05, 0.7, 2),
		new Yokai("Jibanyan", 135, D, Charming, false, statA[143], statB[143], ListAttack[34], ListTechnique[4], "Adrenaline", inspiritList[118], Water, 1.3, Fire, 0.7, 0.55, 0.3, 0.1, 0.05, 0.7, 1),
		new Yokai("Thornyan", 136, B, Charming, false, statA[144], statB[144], ListAttack[46], ListTechnique[19], "Spiky Guard", inspiritList[87], Ice, 1.5, Wind, 0.5, 0.5, 0.35, 0.1, 0.05, 0.8, 1),
		new Yokai("Baddinyan", 137, B, Charming, false, statA[145], statB[145], ListAttack[23], ListTechnique[4], "Pompadour", inspiritList[119], Water, 1.5, Fire, 0.5, 0.7, 0.15, 0.1, 0.05, 0.8, 1),
		new Yokai("Buchinyan", 138, C, Charming, false, statA[146], statB[146], ListAttack[34], ListTechnique[9], "Soft Skin", inspiritList[120], Earth, 1.5, Thunder, 0.7, 0.6, 0.25, 0.1, 0.05, 0.75, 1),
		new Yokai("Walkappa (Bony Spirits)", 139, D, Charming, false, statA[147], statB[147], ListAttack[32], ListTechnique[13], "Skilled Loafer", inspiritList[121], Thunder, 1.5, Water, 0.5, 0.1, 0.7, 0.15, 0.05, 0.7, 1),
		new Yokai("Walkappa (Fleshy Souls)(Rare)", 139, D, Charming, false, statA[148], statB[148], ListAttack[32], ListTechnique[13], "Water Play", inspiritList[121], Thunder, 1.5, Water, 0.5, 0.1, 0.7, 0.15, 0.05, 0.7, 1),
		new Yokai("Appak (Bony Spirits)", 140, A, Charming, false, statA[149], statB[149], ListAttack[8], ListTechnique[22], "Penetrate", inspiritList[122], Thunder, 1.5, Water, 0.2, 0.35, 0.5, 0.1, 0.05, 0.8, 1),
		new Yokai("Appak (Fleshy Souls)(Rare)", 140, A, Charming, false, statA[150], statB[150], ListAttack[8], ListTechnique[22], "Fill 'Er Up", inspiritList[122], Thunder, 1.5, Water, 0.2, 0.35, 0.5, 0.1, 0.05, 0.8, 1),
		new Yokai("Supyo", 141, A, Charming, false, statA[151], statB[151], ListAttack[8], ListTechnique[22], "Penetrate", inspiritList[123], Thunder, 1.5, Water, 0.3, 0.2, 0.65, 0.1, 0.05, 0.8, 1),
		new Yokai("Komasan", 142, D, Charming, false, statA[152], statB[152], ListAttack[32], ListTechnique[1], "Alpha", inspiritList[69], Water, 1.3, Fire, 0.7, 0.1, 0.75, 0.1, 0.05, 0.7, 1),
		new Yokai("Komane", 143, A, Charming, false, statA[153], statB[153], ListAttack[30], ListTechnique[8], "Alpha", inspiritList[69], Water, 1.8, Fire, 0.3, 0.15, 0.7, 0.1, 0.05, 0.8, 1),
		new Yokai("Komajiro (Fleshy Souls)", 144, D, Charming, false, statA[154], statB[154], ListAttack[32], ListTechnique[9], "Omega", inspiritList[124], Earth, 1.5, Thunder, 0.5, 0.35, 0.4, 0.2, 0.05, 0.7, 1),
		new Yokai("Komajiro (Bony Spirits)(Rare)", 144, D, Charming, false, statA[155], statB[155], ListAttack[32], ListTechnique[9], "Lightning Up!", inspiritList[124], Earth, 1.5, Thunder, 0.5, 0.35, 0.4, 0.2, 0.05, 0.7, 1),
		new Yokai("Komiger (Fleshy Souls)", 145, A, Charming, false, statA[156], statB[156], ListAttack[31], ListTechnique[21], "Omega", inspiritList[124], Earth, 1.8, Thunder, 0.3, 0.45, 0.35, 0.15, 0.05, 0.8, 1),
		new Yokai("Komiger (Bony Spirits)(Rare)", 145, A, Charming, false, statA[157], statB[157], ListAttack[31], ListTechnique[21], "Lightning Up!", inspiritList[124], Earth, 1.8, Thunder, 0.3, 0.45, 0.35, 0.15, 0.05, 0.8, 1),
		new Yokai("Baku", 146, D, Charming, false, statA[158], statB[158], ListAttack[36], ListTechnique[3], "Grip on You", inspiritList[125], Earth, 1.3, Thunder, 0.7, 0.2, 0.55, 0.2, 0.05, 0.7, 1),
		new Yokai("Bakulia", 147, B, Charming, false, statA[159], statB[159], ListAttack[38], ListTechnique[14], "Grip on You", inspiritList[125], Earth, 1.5, Thunder, 0.5, 0.1, 0.65, 0.15, 0.1, 0.8, 1),
		new Yokai("Whapir (Bony Spirits)", 148, C, Charming, false, statA[160], statB[160], ListAttack[36], ListTechnique[3], "Good Fortune", inspiritList[126], Water, 1.5, Thunder, 0.5, 0.2, 0.55, 0.2, 0.05, 0.75, 1),
		new Yokai("Whapir (Fleshy Souls)(Rare)", 148, C, Charming, false, statA[161], statB[161], ListAttack[36], ListTechnique[3], "Free to Be", inspiritList[126], Water, 1.5, Thunder, 0.5, 0.2, 0.55, 0.2, 0.05, 0.75, 1),
		new Yokai("Drizzelda", 149, C, Charming, false, statA[162], statB[162], ListAttack[36], ListTechnique[13], "Downpour", inspiritList[127], Thunder, 1.8, Water, 0.3, 0.05, 0.65, 0.25, 0.05, 0.75, 1),
		new Yokai("Nekidspeed", 150, C, Charming, false, statA[163], statB[163], ListAttack[44], ListTechnique[5], "Step Up", inspiritList[128], Earth, 1.5, Ice, 0.5, 0.7, 0.1, 0.15, 0.05, 0.75, 1),
		new Yokai("Shmoopie", 151, C, Charming, false, statA[164], statB[164], ListAttack[2], ListTechnique[15], "Popularity", inspiritList[129], Thunder, 1.3, Water, 0.7, 0.1, 0.65, 0.2, 0.05, 0.75, 1),
		new Yokai("Pinkipoo", 152, B, Charming, false, statA[165], statB[165], ListAttack[1], ListTechnique[11], "Popularity", inspiritList[129], Thunder, 1.5, Water, 0.5, 0.15, 0.6, 0.2, 0.05, 0.8, 1),
		new Yokai("Pookivil", 153, A, Charming, false, statA[166], statB[166], ListAttack[1], ListTechnique[14], "Unpopularity", inspiritList[130], Thunder, 1.8, Earth, 0.5, 0.4, 0.45, 0.1, 0.05, 0.8, 1),
		new Yokai("Harry Barry", 154, B, Charming, false, statA[167], statB[167], ListAttack[30], ListTechnique[15], "Bear Care", inspiritList[131], Neutral, 1.0, Neutral, 1.0, 0.5, 0.4, 0.05, 0.05, 0.8, 1),
		new Yokai("Frostina", 155, B, Charming, false, statA[168], statB[168], ListAttack[36], ListTechnique[2], "Snow Play", inspiritList[132], Fire, 1.5, Ice, 0.5, 0.15, 0.6, 0.2, 0.05, 0.8, 1),
		new Yokai("Blizzaria", 156, S, Charming, false, statA[169], statB[169], ListAttack[38], ListTechnique[2], "Snow Play", inspiritList[132], Fire, 2.0, Ice, 0.2, 0.15, 0.65, 0.15, 0.05, 0.85, 1),
		new Yokai("Damona", 157, S, Charming, false, statA[170], statB[170], ListAttack[38], ListTechnique[2], "Cursed Skin", inspiritList[133], Fire, 2.0, Thunder, 0.7, 0.25, 0.5, 0.2, 0.05, 0.85, 1),
		new Yokai("Faux Kappa", 158, A, Charming, false, statA[171], statB[171], ListAttack[25], ListTechnique[22], "Intimidation", inspiritList[134], Thunder, 1.8, Water, 0.3, 0.3, 0.5, 0.15, 0.05, 0.8, 1),
		new Yokai("Tigappa", 159, S, Charming, false, statA[172], statB[172], ListAttack[25], ListTechnique[22], "Intimidation", inspiritList[134], Thunder, 1.5, Water, 0.3, 0.25, 0.6, 0.1, 0.05, 0.85, 1),
		new Yokai("Master Nyada", 160, S, Charming, false, statA[173], statB[173], ListAttack[1], ListTechnique[18], "Use the Hose", inspiritList[135], Ice, 1.8, Wind, 0.3, 0.05, 0.75, 0.15, 0.05, 0.85, 1),
		new Yokai("Wantston", 161, E, Heartful, false, statA[174], statB[174], ListAttack[36], ListTechnique[17], "Greed", inspiritList[77], Earth, 1.3, Thunder, 0.7, 0.4, 0.35, 0.2, 0.05, 0.65, 1),
		new Yokai("Grubsnitch", 162, D, Heartful, false, statA[175], statB[175], ListAttack[36], ListTechnique[16], "Snitch", inspiritList[136], Ice, 1.3, Earth, 0.7, 0.45, 0.3, 0.2, 0.05, 0.65, 1),
		new Yokai("Wiglin", 163, E, Heartful, false, statA[176], statB[176], ListAttack[36], ListTechnique[7], "Wavy Body", inspiritList[137], Thunder, 1.5, Water, 0.7, 0.5, 0.3, 0.15, 0.05, 0.65, 1),
		new Yokai("Kelpacabana", 164, C, Heartful, false, statA[177], statB[177], ListAttack[38], ListTechnique[11], "Seaweed Samba", inspiritList[138], Ice, 1.5, Water, 0.5, 0.35, 0.5, 0.1, 0.05, 0.7, 1),
		new Yokai("Steppa", 165, E, Heartful, false, statA[178], statB[178], ListAttack[36], ListTechnique[7], "Wavy Body", inspiritList[139], Fire, 1.5, Water, 0.7, 0.25, 0.4, 0.3, 0.05, 0.65, 1),
		new Yokai("Rhyth", 166, D, Heartful, false, statA[179], statB[179], ListAttack[36], ListTechnique[15], "Wavy Body", inspiritList[140], Earth, 1.5, Thunder, 0.7, 0.1, 0.6, 0.25, 0.05, 0.65, 1),
		new Yokai("Hungramps (Fleshy Souls)", 167, E, Heartful, false, statA[180], statB[180], ListAttack[16], ListTechnique[7], "Starver", inspiritList[141], Wind, 1.3, Earth, 0.7, 0.1, 0.6, 0.25, 0.05, 0.65, 1),
		new Yokai("Hungramps (Bony Spirits)(Rare)", 167, E, Heartful, false, statA[181], statB[181], ListAttack[16], ListTechnique[7], "Bear Care", inspiritList[141], Wind, 1.3, Earth, 0.7, 0.1, 0.6, 0.25, 0.05, 0.65, 1),
		new Yokai("Hungorge (Fleshy Souls)", 168, B, Heartful, false, statA[182], statB[182], ListAttack[6], ListTechnique[3], "Starver", inspiritList[141], Wind, 1.5, Earth, 0.5, 0.2, 0.6, 0.15, 0.05, 0.75, 1),
		new Yokai("Hungorge (Bony Spirits)(Rare)", 168, B, Heartful, false, statA[183], statB[183], ListAttack[6], ListTechnique[3], "Bear Care", inspiritList[141], Wind, 1.5, Earth, 0.5, 0.2, 0.6, 0.15, 0.05, 0.75, 1),
		new Yokai("Grainpa", 169, B, Heartful, false, statA[184], statB[184], ListAttack[16], ListTechnique[15], "Blessed Body", inspiritList[142], Wind, 1.8, Earth, 0.5, 0.3, 0.45, 0.2, 0.05, 0.75, 1),
		new Yokai("Tongus", 170, E, Heartful, false, statA[185], statB[185], ListAttack[37], ListTechnique[7], "Lick It Clean", inspiritList[143], Fire, 1.3, Thunder, 0.7, 0.1, 0.6, 0.25, 0.05, 0.65, 1),
		new Yokai("Nurse Tongus", 171, B, Heartful, false, statA[186], statB[186], ListAttack[37], ListTechnique[11], "Lick It Clean", inspiritList[143], Fire, 1.5, Thunder, 0.5, 0.05, 0.7, 0.2, 0.05, 0.75, 1),
		new Yokai("Sandmeh (Bony Spirits)", 172, E, Heartful, false, statA[187], statB[187], ListAttack[16], ListTechnique[7], "Sand Still", inspiritList[144], Water, 1.5, Earth, 0.5, 0.55, 0.2, 0.15, 0.1, 0.65, 1),
		new Yokai("Sandmeh (Fleshy Souls)(Rare)", 172, E, Heartful, false, statA[188], statB[188], ListAttack[16], ListTechnique[7], "Carefree Spirit", inspiritList[144], Water, 1.5, Earth, 0.5, 0.55, 0.2, 0.15, 0.1, 0.65, 1),
		new Yokai("Mr. Sandmeh (Bony Spirits)", 173, B, Heartful, false, statA[189], statB[189], ListAttack[16], ListTechnique[15], "Sand Still", inspiritList[144], Water, 1.8, Earth, 0.3, 0.45, 0.35, 0.1, 0.1, 0.75, 1),
		new Yokai("Mr. Sandmeh (Fleshy Souls)(Rare)", 173, B, Heartful, false, statA[190], statB[190], ListAttack[16], ListTechnique[15], "Carefree Spirit", inspiritList[144], Water, 1.8, Earth, 0.3, 0.45, 0.35, 0.1, 0.1, 0.75, 1),
		new Yokai("Pallysol", 174, E, Heartful, false, statA[191], statB[191], ListAttack[27], ListTechnique[23], "Sun Shield", inspiritList[145], Ice, 1.3, Wind, 0.7, 0.2, 0.45, 0.25, 0.1, 0.65, 1),
		new Yokai("Scarasol", 175, A, Heartful, false, statA[192], statB[192], ListAttack[46], ListTechnique[16], "Sun Shield", inspiritList[146], Wind, 1.5, Earth, 0.5, 0.45, 0.35, 0.1, 0.1, 0.8, 1),
		new Yokai("Lodo", 176, D, Heartful, false, statA[193], statB[193], ListAttack[19], ListTechnique[23], "Stealing", inspiritList[147], Ice, 1.3, Wind, 0.7, 0.35, 0.5, 0.1, 0.05, 0.65, 1),
		new Yokai("Supoor Hero", 177, A, Heartful, false, statA[194], statB[194], ListAttack[11], ListTechnique[18], "Acrobat", inspiritList[148], Ice, 1.5, Wind, 0.5, 0.35, 0.5, 0.1, 0.05, 0.8, 1),
		new Yokai("Chippa", 178, C, Heartful, false, statA[195], statB[195], ListAttack[11], ListTechnique[20], "Optimism Power", inspiritList[149], Thunder, 1.3, Water, 0.7, 0.45, 0.25, 0.25, 0.05, 0.7, 1),
		new Yokai("Gnomey", 179, D, Heartful, false, statA[196], statB[196], ListAttack[17], ListTechnique[7], "Good Fortune", inspiritList[150], Fire, 1.3, Earth, 0.7, 0.2, 0.6, 0.15, 0.05, 0.65, 1),
		new Yokai("High Gnomey", 180, A, Heartful, false, statA[197], statB[197], ListAttack[17], ListTechnique[11], "Golden Touch", inspiritList[151], Fire, 1.5, Earth, 0.5, 0.1, 0.7, 0.15, 0.05, 0.8, 1),
		new Yokai("Enerfly", 181, D, Heartful, false, statA[198], statB[198], ListAttack[36], ListTechnique[7], "Miraculous Scales", inspiritList[152], Thunder, 1.3, Water, 0.7, 0.3, 0.4, 0.25, 0.05, 0.65, 1),
		new Yokai("Enefly", 182, D, Heartful, false, statA[199], statB[199], ListAttack[36], ListTechnique[0], "Miraculous Scales", inspiritList[153], Earth, 1.3, Thunder, 0.7, 0.2, 0.5, 0.25, 0.05, 0.65, 1),
	};
}

private static Yokai[] medaillum_2() {
	return new Yokai[] {
		new Yokai("Betterfly", 183, A, Heartful, false, statA[200], statB[200], ListAttack[36], ListTechnique[11], "Miraculous Scales", inspiritList[154], Ice, 1.5, Wind, 0.5, 0.2, 0.55, 0.2, 0.05, 0.8, 1),
		new Yokai("Peppillon", 184, S, Heartful, false, statA[201], statB[201], ListAttack[36], ListTechnique[11], "Miraculous Scales", inspiritList[155], Earth, 2.0, Thunder, 0.5, 0.25, 0.55, 0.15, 0.05, 0.85, 1),
		new Yokai("Predictabull", 185, D, Heartful, false, statA[202], statB[202], ListAttack[3], ListTechnique[7], "Clairvoidance", inspiritList[156], Water, 1.3, Earth, 0.7, 0.35, 0.4, 0.2, 0.05, 0.65, 1),
		new Yokai("Smashibull", 186, S, Heartful, false, statA[203], statB[203], ListAttack[4], ListTechnique[11], "Clairvoidance", inspiritList[156], Water, 1.5, Earth, 0.5, 0.5, 0.35, 0.05, 0.1, 0.85, 1),
		new Yokai("Don Chan", 187, C, Heartful, false, statA[204], statB[204], ListAttack[3], ListTechnique[15], "Feel the Beat", inspiritList[157], Water, 1.5, Earth, 0.5, 0.1, 0.7, 0.1, 0.1, 0.7, 1),
		new Yokai("Ray O'Light", 188, C, Heartful, false, statA[205], statB[205], ListAttack[11], ListTechnique[1], "Sunburn", inspiritList[158], Water, 1.8, Fire, 0.3, 0.5, 0.35, 0.1, 0.05, 0.7, 1),
		new Yokai("Happierre", 189, C, Heartful, false, statA[206], statB[206], ListAttack[3], ListTechnique[15], "Caring", inspiritList[159], Earth, 1.3, Thunder, 0.7, 0.15, 0.5, 0.3, 0.05, 0.7, 1),
		new Yokai("Reversa", 190, A, Heartful, false, statA[207], statB[207], ListAttack[44], ListTechnique[11], "Insecure", inspiritList[160], Earth, 1.5, Thunder, 0.5, 0.2, 0.5, 0.25, 0.05, 0.8, 1),
		new Yokai("Reversette", 191, A, Heartful, false, statA[208], statB[208], ListAttack[44], ListTechnique[18], "Insecure", inspiritList[160], Ice, 1.8, Thunder, 0.5, 0.35, 0.4, 0.2, 0.05, 0.8, 1),
		new Yokai("Ol' Saint Trick", 192, B, Heartful, false, statA[209], statB[209], ListAttack[12], ListTechnique[15], "Caring", inspiritList[110], Ice, 1.5, Wind, 0.5, 0.25, 0.6, 0.1, 0.05, 0.75, 1),
		new Yokai("Ol' Fortune", 193, B, Heartful, false, statA[210], statB[210], ListAttack[12], ListTechnique[9], "Penetrate", inspiritList[110], Earth, 1.5, Thunder, 0.5, 0.6, 0.25, 0.1, 0.05, 0.75, 1),
		new Yokai("Rollen", 194, B, Heartful, false, statA[211], statB[211], ListAttack[9], ListTechnique[13], "Gambler", inspiritList[161], Thunder, 1.5, Earth, 0.5, 0.3, 0.3, 0.3, 0.1, 0.75, 1),
		new Yokai("Dubbles", 195, A, Heartful, false, statA[212], statB[212], ListAttack[9], ListTechnique[22], "Gambler", inspiritList[162], Thunder, 1.5, Earth, 0.5, 0.3, 0.3, 0.3, 0.1, 0.8, 1),
		new Yokai("Papa Bolt", 196, A, Heartful, false, statA[213], statB[213], ListAttack[31], ListTechnique[21], "Strict", inspiritList[163], Earth, 1.8, Thunder, 0.3, 0.4, 0.45, 0.1, 0.05, 0.8, 1),
		new Yokai("Uncle Infinite", 197, S, Heartful, false, statA[214], statB[214], ListAttack[31], ListTechnique[21], "Intimidation", inspiritList[164], Earth, 1.8, Thunder, 0.2, 0.5, 0.35, 0.1, 0.05, 0.85, 1),
		new Yokai("Mama Aura", 198, A, Heartful, false, statA[215], statB[215], ListAttack[36], ListTechnique[11], "Prayer", inspiritList[165], Ice, 1.5, Wind, 0.5, 0.15, 0.65, 0.15, 0.05, 0.8, 1),
		new Yokai("Auntie Heart", 199, S, Heartful, false, statA[216], statB[216], ListAttack[36], ListTechnique[11], "Prayer", inspiritList[166], Ice, 1.5, Thunder, 0.7, 0.2, 0.6, 0.15, 0.05, 0.85, 1),
		new Yokai("Kyryn", 200, S, Heartful, false, statA[217], statB[217], ListAttack[6], ListTechnique[11], "Second Wind", inspiritList[167], Earth, 1.5, Thunder, 0.5, 0.25, 0.55, 0.15, 0.05, 0.85, 1),
		new Yokai("Unikirin", 201, S, Heartful, false, statA[218], statB[218], ListAttack[6], ListTechnique[11], "Second Wind", inspiritList[168], Fire, 1.5, Thunder, 0.5, 0.5, 0.35, 0.1, 0.05, 0.85, 1),
		new Yokai("Leadoni", 202, E, Shady, false, statA[219], statB[219], ListAttack[36], ListTechnique[6], "Windshield", inspiritList[169], Fire, 1.3, Ice, 0.7, 0.55, 0.2, 0.2, 0.05, 0.6, 2),
		new Yokai("Mynimo", 203, D, Shady, false, statA[220], statB[220], ListAttack[36], ListTechnique[0], "Windshield", inspiritList[170], Fire, 1.5, Ice, 0.5, 0.5, 0.25, 0.2, 0.05, 0.6, 1),
		new Yokai("Ake", 204, E, Shady, false, statA[221], statB[221], ListAttack[19], ListTechnique[12], "Extreme Critical", inspiritList[171], Wind, 1.3, Earth, 0.7, 0.4, 0.3, 0.25, 0.05, 0.6, 1),
		new Yokai("Payn", 205, C, Shady, false, statA[222], statB[222], ListAttack[30], ListTechnique[16], "Extreme Critical", inspiritList[171], Wind, 1.5, Earth, 0.5, 0.65, 0.1, 0.2, 0.05, 0.65, 1),
		new Yokai("Agon", 206, B, Shady, false, statA[223], statB[223], ListAttack[30], ListTechnique[10], "Extreme Critical", inspiritList[172], Wind, 1.8, Earth, 0.5, 0.7, 0.05, 0.2, 0.05, 0.65, 1),
		new Yokai("Wydeawake", 207, E, Shady, false, statA[224], statB[224], ListAttack[32], ListTechnique[17], "Night Life", inspiritList[173], Earth, 1.3, Thunder, 0.7, 0.1, 0.55, 0.3, 0.05, 0.6, 1),
		new Yokai("Allnyta", 208, B, Shady, false, statA[225], statB[225], ListAttack[32], ListTechnique[9], "Night Life", inspiritList[174], Earth, 1.5, Thunder, 0.5, 0.05, 0.6, 0.3, 0.05, 0.65, 1),
		new Yokai("Herbiboy", 209, E, Shady, false, statA[226], statB[226], ListAttack[3], ListTechnique[20], "Herbivaura", inspiritList[175], Thunder, 1.3, Water, 0.7, 0.55, 0.1, 0.3, 0.05, 0.6, 1),
		new Yokai("Carniboy", 210, B, Shady, false, statA[227], statB[227], ListAttack[11], ListTechnique[1], "Carnivaura", inspiritList[176], Water, 1.5, Fire, 0.5, 0.6, 0.05, 0.3, 0.05, 0.65, 1),
		new Yokai("Negatibuzz", 211, E, Shady, false, statA[228], statB[228], ListAttack[27], ListTechnique[0], "Vampiric", inspiritList[177], Ice, 1.3, Wind, 0.7, 0.4, 0.35, 0.2, 0.05, 0.6, 1),
		new Yokai("Moskevil", 212, C, Shady, false, statA[229], statB[229], ListAttack[28], ListTechnique[3], "Vampiric", inspiritList[177], Ice, 1.5, Wind, 0.5, 0.4, 0.35, 0.2, 0.05, 0.65, 1),
		new Yokai("Scritchy", 213, A, Shady, false, statA[230], statB[230], ListAttack[28], ListTechnique[21], "Vampiric", inspiritList[178], Earth, 1.8, Thunder, 0.5, 0.15, 0.6, 0.2, 0.05, 0.7, 1),
		new Yokai("Dimmy (Bony Spirits)", 214, E, Shady, false, statA[231], statB[231], ListAttack[43], ListTechnique[23], "Secrecy", inspiritList[107], Ice, 1.3, Wind, 0.7, 0.7, 0.2, 0.05, 0.05, 0.6, 1),
		new Yokai("Dimmy (Fleshy Souls)(Rare)", 214, E, Shady, false, statA[232], statB[232], ListAttack[43], ListTechnique[23], "Wavy Body", inspiritList[107], Ice, 1.3, Wind, 0.7, 0.7, 0.2, 0.05, 0.05, 0.6, 1),
		new Yokai("Blandon (Bony Spirits)", 215, B, Shady, false, statA[233], statB[233], ListAttack[24], ListTechnique[19], "Secrecy", inspiritList[107], Ice, 1.5, Wind, 0.5, 0.6, 0.3, 0.05, 0.05, 0.65, 1),
		new Yokai("Blandon (Fleshy Souls)(Rare)", 215, B, Shady, false, statA[234], statB[234], ListAttack[24], ListTechnique[19], "Wavy Body", inspiritList[107], Ice, 1.5, Wind, 0.5, 0.6, 0.3, 0.05, 0.05, 0.65, 1),
		new Yokai("Nul", 216, A, Shady, false, statA[235], statB[235], ListAttack[24], ListTechnique[18], "Secrecy", inspiritList[179], Ice, 1.8, Wind, 0.3, 0.3, 0.6, 0.05, 0.05, 0.7, 1),
		new Yokai("Suspicioni (Bony Spirits)", 217, D, Shady, false, statA[236], statB[236], ListAttack[28], ListTechnique[20], "Suspicion", inspiritList[180], Thunder, 1.3, Water, 0.7, 0.25, 0.4, 0.3, 0.05, 0.6, 2),
		new Yokai("Suspicioni (Fleshy Souls)(Rare)", 217, D, Shady, false, statA[237], statB[237], ListAttack[28], ListTechnique[20], "Eyesight A", inspiritList[180], Thunder, 1.3, Water, 0.7, 0.25, 0.4, 0.3, 0.05, 0.6, 2),
		new Yokai("Tantroni", 218, D, Shady, false, statA[238], statB[238], ListAttack[28], ListTechnique[4], "Suspicion", inspiritList[181], Water, 1.3, Fire, 0.7, 0.55, 0.15, 0.25, 0.05, 0.6, 2),
		new Yokai("Contrarioni", 219, B, Shady, false, statA[239], statB[239], ListAttack[28], ListTechnique[9], "Suspicion", inspiritList[182], Earth, 1.5, Thunder, 0.5, 0.3, 0.4, 0.25, 0.05, 0.65, 1),
		new Yokai("Hidabat", 220, D, Shady, false, statA[240], statB[240], ListAttack[36], ListTechnique[19], "Vampiric", inspiritList[183], Ice, 1.3, Wind, 0.7, 0.25, 0.35, 0.35, 0.05, 0.6, 1),
		new Yokai("Abodabat", 221, A, Shady, false, statA[241], statB[241], ListAttack[44], ListTechnique[19], "Vampiric", inspiritList[183], Ice, 1.5, Wind, 0.5, 0.2, 0.35, 0.4, 0.05, 0.7, 1),
		new Yokai("Belfree", 222, A, Shady, false, statA[242], statB[242], ListAttack[44], ListTechnique[18], "Vampiric", inspiritList[183], Ice, 1.7, Earth, 0.7, 0.35, 0.2, 0.4, 0.05, 0.7, 1),
		new Yokai("Yoink", 223, D, Shady, false, statA[243], statB[243], ListAttack[2], ListTechnique[0], "Sticky Fingers", inspiritList[184], Thunder, 1.3, Ice, 0.7, 0.5, 0.1, 0.35, 0.05, 0.6, 1),
		new Yokai("Gimme", 224, A, Shady, false, statA[244], statB[244], ListAttack[30], ListTechnique[3], "Sticky Fingers", inspiritList[185], Thunder, 1.5, Ice, 0.5, 0.55, 0.05, 0.35, 0.05, 0.7, 1),
		new Yokai("K'mon-K'mon", 225, C, Shady, false, statA[245], statB[245], ListAttack[25], ListTechnique[19], "Me First!", inspiritList[186], Ice, 1.5, Wind, 0.5, 0.35, 0.3, 0.3, 0.05, 0.65, 1),
		new Yokai("Yoodooit", 226, C, Shady, false, statA[246], statB[246], ListAttack[17], ListTechnique[3], "You First", inspiritList[187], Earth, 1.5, Fire, 0.5, 0.1, 0.4, 0.45, 0.05, 0.65, 1),
		new Yokai("Count Zapaway", 227, C, Shady, false, statA[247], statB[247], ListAttack[44], ListTechnique[5], "Zap Away", inspiritList[188], Fire, 1.5, Ice, 0.5, 0.4, 0.2, 0.3, 0.1, 0.65, 1),
		new Yokai("Tyrat", 228, C, Shady, false, statA[248], statB[248], ListAttack[6], ListTechnique[3], "Dirty Rat", inspiritList[189], Wind, 1.5, Fire, 0.5, 0.5, 0.1, 0.35, 0.05, 0.65, 2),
		new Yokai("Tengloom", 229, C, Shady, false, statA[249], statB[249], ListAttack[11], ListTechnique[19], "Windshield", inspiritList[190], Ice, 1.3, Wind, 0.7, 0.2, 0.5, 0.25, 0.05, 0.65, 1),
		new Yokai("Nird", 230, B, Shady, false, statA[250], statB[250], ListAttack[11], ListTechnique[18], "Death Sphere", inspiritList[18], Ice, 1.5, Wind, 0.5, 0.15, 0.6, 0.2, 0.05, 0.65, 1),
		new Yokai("Snobetty", 231, B, Shady, false, statA[251], statB[251], ListAttack[38], ListTechnique[2], "Know Your Place", inspiritList[191], Fire, 1.5, Ice, 0.5, 0.15, 0.5, 0.3, 0.05, 0.65, 1),
		new Yokai("Slimamander", 232, B, Shady, false, statA[252], statB[252], ListAttack[7], ListTechnique[8], "Triple-Header", inspiritList[69], Water, 1.5, Fire, 0.3, 0.5, 0.35, 0.1, 0.05, 0.65, 1),
		new Yokai("Dracunyan", 233, B, Shady, false, statA[253], statB[253], ListAttack[21], ListTechnique[14], "Bloodsucker", inspiritList[192], Fire, 1.5, Thunder, 0.3, 0.6, 0.15, 0.2, 0.05, 0.65, 1),
		new Yokai("Negasus", 234, A, Shady, false, statA[254], statB[254], ListAttack[6], ListTechnique[19], "Hanging In", inspiritList[193], Ice, 1.5, Thunder, 0.7, 0.1, 0.65, 0.2, 0.05, 0.7, 1),
		new Yokai("Neighfarious", 235, A, Shady, false, statA[255], statB[255], ListAttack[6], ListTechnique[3], "Cursed Skin", inspiritList[194], Earth, 1.8, Thunder, 0.7, 0.65, 0.1, 0.2, 0.05, 0.7, 1),
		new Yokai("Timidevil", 236, A, Shady, false, statA[256], statB[256], ListAttack[41], ListTechnique[1], "Too Afraid", inspiritList[195], Water, 1.3, Fire, 0.7, 0.75, 0.1, 0.1, 0.05, 0.7, 1),
		new Yokai("Beelzebold", 237, S, Shady, false, statA[257], statB[257], ListAttack[41], ListTechnique[8], "Intimidation", inspiritList[195], Water, 1.5, Fire, 0.5, 0.55, 0.2, 0.2, 0.05, 0.75, 1),
		new Yokai("Count Cavity", 238, S, Shady, false, statA[258], statB[258], ListAttack[41], ListTechnique[8], "Extreme Critical", inspiritList[196], Water, 1.8, Fire, 0.5, 0.25, 0.5, 0.2, 0.05, 0.75, 1),
		new Yokai("Eyesoar", 239, A, Shady, false, statA[259], statB[259], ListAttack[22], ListTechnique[10], "Eye See You", inspiritList[197], Wind, 1.5, Earth, 0.3, 0.4, 0.35, 0.2, 0.05, 0.7, 1),
		new Yokai("Eyellure", 240, S, Shady, false, statA[260], statB[260], ListAttack[22], ListTechnique[21], "Eye See You", inspiritList[197], Earth, 1.5, Thunder, 0.3, 0.3, 0.4, 0.25, 0.05, 0.75, 1),
		new Yokai("Greesel", 241, S, Shady, false, statA[261], statB[261], ListAttack[7], ListTechnique[8], "Mine", inspiritList[198], Water, 1.3, Fire, 0.7, 0.05, 0.55, 0.35, 0.05, 0.75, 1),
		new Yokai("Awevil", 242, S, Shady, false, statA[262], statB[262], ListAttack[7], ListTechnique[13], "Ultimate Dark", inspiritList[199], Thunder, 1.8, Water, 0.5, 0.1, 0.45, 0.4, 0.05, 0.75, 1),
		new Yokai("Wobblewok", 243, S, Shady, false, statA[263], statB[263], ListAttack[4], ListTechnique[10], "Ultimate Dark", inspiritList[200], Wind, 1.5, Earth, 0.3, 0.15, 0.15, 0.6, 0.1, 0.75, 1),
		new Yokai("Coughkoff", 244, E, Eerie, false, statA[264], statB[264], ListAttack[27], ListTechnique[20], "Spiky Guard", inspiritList[201], Thunder, 2.0, Earth, 0.7, 0.4, 0.05, 0.45, 0.1, 0.6, 1),
		new Yokai("Hurchin", 245, D, Eerie, false, statA[265], statB[265], ListAttack[27], ListTechnique[5], "Spiky Guard", inspiritList[202], Fire, 2.0, Thunder, 0.7, 0.05, 0.4, 0.45, 0.1, 0.65, 1),
		new Yokai("Droplette", 246, E, Eerie, false, statA[266], statB[266], ListAttack[3], ListTechnique[13], "Moist Skin", inspiritList[203], Thunder, 1.8, Water, 0.3, 0.05, 0.7, 0.2, 0.05, 0.6, 1),
		new Yokai("Drizzle", 247, B, Eerie, false, statA[267], statB[267], ListAttack[3], ListTechnique[22], "Moist Skin", inspiritList[203], Thunder, 2.0, Water, 0.2, 0.05, 0.75, 0.15, 0.05, 0.75, 1),
		new Yokai("Slush", 248, E, Eerie, false, statA[268], statB[268], ListAttack[3], ListTechnique[5], "Stiff Skin", inspiritList[132], Fire, 1.8, Ice, 0.3, 0.05, 0.7, 0.2, 0.05, 0.6, 1),
		new Yokai("Alhail", 249, B, Eerie, false, statA[269], statB[269], ListAttack[3], ListTechnique[2], "Stiff Skin", inspiritList[204], Fire, 2.0, Ice, 0.2, 0.05, 0.75, 0.15, 0.05, 0.75, 1),
		new Yokai("Gush", 250, D, Eerie, false, statA[270], statB[270], ListAttack[3], ListTechnique[1], "Good Fortune", inspiritList[205], Water, 2.0, Thunder, 0.7, 0.05, 0.7, 0.2, 0.05, 0.65, 1),
		new Yokai("Peckpocket", 251, E, Eerie, false, statA[271], statB[271], ListAttack[40], ListTechnique[0], "Glossy Skin", inspiritList[206], Fire, 1.3, Ice, 0.7, 0.5, 0.15, 0.25, 0.1, 0.6, 1),
		new Yokai("Robbinyu", 252, B, Eerie, false, statA[272], statB[272], ListAttack[1], ListTechnique[3], "Glossy Skin", inspiritList[207], Fire, 1.5, Ice, 0.5, 0.6, 0.1, 0.25, 0.05, 0.75, 1),
		new Yokai("Rockabelly (Fleshy Souls)", 253, D, Eerie, false, statA[273], statB[273], ListAttack[40], ListTechnique[3], "Glossy Skin", inspiritList[208], Earth, 1.5, Thunder, 0.5, 0.15, 0.5, 0.25, 0.1, 0.65, 1),
		new Yokai("Rockabelly (Bony Spirits)(Rare)", 253, D, Eerie, false, statA[274], statB[274], ListAttack[40], ListTechnique[3], "Long Lasting", inspiritList[208], Earth, 1.5, Thunder, 0.5, 0.15, 0.5, 0.25, 0.1, 0.65, 1),
		new Yokai("Squeeky", 254, E, Eerie, false, statA[275], statB[275], ListAttack[17], ListTechnique[6], "Noise Pollution", inspiritList[209], Fire, 1.3, Ice, 0.7, 0.45, 0.2, 0.3, 0.05, 0.6, 1),
		new Yokai("Rawry", 255, B, Eerie, false, statA[276], statB[276], ListAttack[44], ListTechnique[5], "Noise Pollution", inspiritList[210], Fire, 1.5, Ice, 0.5, 0.55, 0.15, 0.25, 0.05, 0.75, 1),
		new Yokai("Buhu", 256, E, Eerie, false, statA[277], statB[277], ListAttack[27], ListTechnique[23], "Wind Play", inspiritList[211], Ice, 1.3, Wind, 0.7, 0.1, 0.55, 0.3, 0.05, 0.6, 2),
		new Yokai("Flumpy", 257, C, Eerie, false, statA[278], statB[278], ListAttack[27], ListTechnique[19], "Wind Play", inspiritList[212], Ice, 1.5, Wind, 0.5, 0.1, 0.55, 0.3, 0.05, 0.7, 1),
		new Yokai("Skreek", 258, A, Eerie, false, statA[279], statB[279], ListAttack[27], ListTechnique[18], "Penetrate", inspiritList[213], Ice, 1.5, Fire, 0.7, 0.45, 0.25, 0.25, 0.05, 0.8, 1),
		new Yokai("Manjimutt", 259, E, Eerie, false, statA[280], statB[280], ListAttack[6], ListTechnique[1], "Mutt's Paradise", inspiritList[214], Water, 1.3, Fire, 0.7, 0.5, 0.35, 0.1, 0.05, 0.6, 1),
		new Yokai("Multimutt", 260, B, Eerie, false, statA[281], statB[281], ListAttack[6], ListTechnique[8], "Mutt's Paradise", inspiritList[214], Water, 1.5, Fire, 0.5, 0.7, 0.1, 0.15, 0.05, 0.75, 1),
		new Yokai("Sir Berus", 261, A, Eerie, false, statA[282], statB[282], ListAttack[6], ListTechnique[10], "Mutt's Paradise", inspiritList[215], Wind, 1.8, Earth, 0.5, 0.3, 0.5, 0.15, 0.05, 0.8, 1),
		new Yokai("Furgus", 262, E, Eerie, false, statA[283], statB[283], ListAttack[45], ListTechnique[12], "Hairnet", inspiritList[216], Wind, 1.3, Earth, 0.7, 0.05, 0.4, 0.45, 0.1, 0.6, 1),
		new Yokai("Furdinand", 263, A, Eerie, false, statA[284], statB[284], ListAttack[44], ListTechnique[10], "Haiwax", inspiritList[217], Wind, 1.5, Earth, 0.5, 0.05, 0.5, 0.35, 0.1, 0.8, 1),
		new Yokai("Nosirs", 264, D, Eerie, false, statA[285], statB[285], ListAttack[36], ListTechnique[15], "Spin-no-rama", inspiritList[218], Earth, 1.3, Water, 0.7, 0.25, 0.25, 0.25, 0.25, 0.65, 1),
		new Yokai("Dismarelda", 265, D, Eerie, false, statA[286], statB[286], ListAttack[40], ListTechnique[16], "Cursed Skin", inspiritList[219], Wind, 1.3, Earth, 0.7, 0.1, 0.5, 0.35, 0.05, 0.65, 1),
		new Yokai("Chatalie", 266, D, Eerie, false, statA[287], statB[287], ListAttack[2], ListTechnique[17], "Skilled Loafer", inspiritList[220], Earth, 1.3, Thunder, 0.7, 0.25, 0.4, 0.3, 0.05, 0.65, 1),
		new Yokai("Nagatha (Fleshy Souls)", 267, C, Eerie, false, statA[288], statB[288], ListAttack[2], ListTechnique[3], "Skilled Loafer", inspiritList[221], Fire, 1.3, Thunder, 0.7, 0.6, 0.15, 0.2, 0.05, 0.7, 1),
		new Yokai("Nagatha (Bony Spirits)(Rare)", 267, C, Eerie, false, statA[289], statB[289], ListAttack[2], ListTechnique[3], "Too Serious", inspiritList[221], Fire, 1.3, Thunder, 0.7, 0.6, 0.15, 0.2, 0.05, 0.7, 1),
		new Yokai("Papa Windbag", 268, C, Eerie, false, statA[290], statB[290], ListAttack[11], ListTechnique[9], "Center Stage", inspiritList[222], Earth, 1.5, Thunder, 0.5, 0.1, 0.5, 0.35, 0.05, 0.7, 1),
		new Yokai("Ben Tover", 269, C, Eerie, false, statA[291], statB[291], ListAttack[3], ListTechnique[19], "Dodge", inspiritList[223], Ice, 1.5, Wind, 0.5, 0.2, 0.4, 0.3, 0.1, 0.7, 1),
		new Yokai("Cheeksqueek", 270, C, Eerie, false, statA[292], statB[292], ListAttack[15], ListTechnique[5], "Gassy Sphere", inspiritList[224], Fire, 1.3, Ice, 0.7, 0.4, 0.3, 0.25, 0.05, 0.7, 1),
		new Yokai("Cuttincheez", 271, A, Eerie, false, statA[293], statB[293], ListAttack[15], ListTechnique[5], "Sense of Smell", inspiritList[224], Fire, 1.5, Ice, 0.5, 0.3, 0.4, 0.25, 0.05, 0.8, 1),
		new Yokai("Toiletta", 272, C, Eerie, false, statA[294], statB[294], ListAttack[36], ListTechnique[3], "Curse Worsener", inspiritList[225], Earth, 1.5, Water, 0.5, 0.1, 0.65, 0.2, 0.05, 0.7, 1),
		new Yokai("Foiletta", 273, A, Eerie, false, statA[295], statB[295], ListAttack[38], ListTechnique[14], "Curse Worsener", inspiritList[226], Earth, 1.8, Water, 0.3, 0.05, 0.7, 0.2, 0.05, 0.8, 1),
		new Yokai("Sproink", 274, B, Eerie, false, statA[296], statB[296], ListAttack[1], ListTechnique[8], "Pigskin", inspiritList[227], Water, 1.5, Fire, 0.3, 0.3, 0.5, 0.1, 0.1, 0.75, 1),
		new Yokai("Compunzer", 275, A, Eerie, false, statA[297], statB[297], ListAttack[1], ListTechnique[3], "Hanging In", inspiritList[228], Ice, 1.3, Wind, 0.7, 0.25, 0.45, 0.25, 0.05, 0.8, 1),
		new Yokai("Lamedian", 276, A, Eerie, false, statA[298], statB[298], ListAttack[1], ListTechnique[14], "Hanging In", inspiritList[228], Fire, 1.5, Thunder, 0.5, 0.4, 0.25, 0.3, 0.05, 0.8, 1),
		new Yokai("Grumples", 277, B, Eerie, false, statA[299], statB[299], ListAttack[17], ListTechnique[0], "Oldness Zone", inspiritList[229], Thunder, 1.3, Water, 0.7, 0.1, 0.35, 0.5, 0.05, 0.75, 1),
	};
}

private static Yokai[] medaillum_3() {
	return new Yokai[] {
		new Yokai("Everfore", 278, S, Eerie, false, statA[300], statB[300], ListAttack[1], ListTechnique[14], "Oldness Zone", inspiritList[230], Thunder, 1.5, Water, 0.5, 0.1, 0.55, 0.3, 0.05, 0.8, 1),
		new Yokai("Eterna", 279, S, Eerie, false, statA[301], statB[301], ListAttack[1], ListTechnique[14], "Oldness Zone", inspiritList[231], Earth, 1.5, Thunder, 0.7, 0.25, 0.4, 0.3, 0.05, 0.8, 1),
		new Yokai("Insomni", 280, A, Eerie, false, statA[302], statB[302], ListAttack[36], ListTechnique[2], "Insecure", inspiritList[232], Earth, 1.3, Thunder, 0.7, 0.25, 0.35, 0.35, 0.05, 0.8, 1),
		new Yokai("Sandi", 281, S, Eerie, false, statA[303], statB[303], ListAttack[36], ListTechnique[14], "Grip on You", inspiritList[125], Ice, 1.5, Thunder, 0.5, 0.1, 0.45, 0.4, 0.05, 0.8, 1),
		new Yokai("Arachnus", 282, S, Eerie, false, statA[304], statB[304], ListAttack[25], ListTechnique[10], "Highlander", inspiritList[233], Wind, 1.8, Earth, 0.3, 0.1, 0.7, 0.15, 0.05, 0.8, 1),
		new Yokai("Arachnia", 283, S, Eerie, false, statA[305], statB[305], ListAttack[25], ListTechnique[10], "Highlander", inspiritList[233], Wind, 1.8, Earth, 0.2, 0.7, 0.1, 0.15, 0.05, 0.8, 1),
		new Yokai("Cricky", 284, E, Slippery, false, statA[306], statB[306], ListAttack[16], ListTechnique[13], "Rest Less", inspiritList[234], Thunder, 1.5, Water, 0.5, 0.2, 0.6, 0.15, 0.05, 0.4, 1),
		new Yokai("Noko", 285, E, Slippery, false, statA[307], statB[307], ListAttack[2], ListTechnique[16], "Good Fortune", inspiritList[235], Wind, 1.5, Earth, 0.5, 0.05, 0.55, 0.3, 0.1, 0.4, 1),
		new Yokai("Bloominoko", 286, A, Slippery, false, statA[308], statB[308], ListAttack[21], ListTechnique[10], "Good Fortune", inspiritList[235], Wind, 1.8, Earth, 0.3, 0.1, 0.65, 0.2, 0.05, 0.6, 1),
		new Yokai("Pandanoko", 287, A, Slippery, false, statA[309], statB[309], ListAttack[21], ListTechnique[2], "Summon", inspiritList[236], Neutral, 1.0, Earth, 0.8, 0.6, 0.05, 0.3, 0.05, 0.6, 2),
		new Yokai("Snaggly", 288, E, Slippery, false, statA[310], statB[310], ListAttack[17], ListTechnique[17], "Hassle", inspiritList[237], Earth, 1.3, Thunder, 0.7, 0.5, 0.3, 0.15, 0.05, 0.4, 1),
		new Yokai("Whinona", 289, A, Slippery, false, statA[311], statB[311], ListAttack[44], ListTechnique[9], "Hassle", inspiritList[238], Earth, 1.5, Thunder, 0.5, 0.45, 0.35, 0.1, 0.1, 0.6, 1),
		new Yokai("Heheheel", 290, D, Slippery, false, statA[312], statB[312], ListAttack[6], ListTechnique[7], "Jar Guard", inspiritList[239], Wind, 1.3, Fire, 0.7, 0.5, 0.2, 0.25, 0.05, 0.45, 1),
		new Yokai("Croonger", 291, C, Slippery, false, statA[313], statB[313], ListAttack[6], ListTechnique[3], "Jar Guard", inspiritList[240], Fire, 1.3, Ice, 0.7, 0.4, 0.3, 0.25, 0.05, 0.5, 1),
		new Yokai("Urnaconda", 292, C, Slippery, false, statA[314], statB[314], ListAttack[6], ListTechnique[15], "Jar Guard", inspiritList[241], Earth, 1.3, Thunder, 0.7, 0.6, 0.1, 0.25, 0.05, 0.5, 1),
		new Yokai("Fishpicable", 293, D, Slippery, false, statA[315], statB[315], ListAttack[0], ListTechnique[9], "Waterproof", inspiritList[242], Earth, 1.3, Thunder, 0.7, 0.4, 0.45, 0.1, 0.05, 0.45, 1),
		new Yokai("Rageon", 294, B, Slippery, false, statA[316], statB[316], ListAttack[8], ListTechnique[9], "Waterproof", inspiritList[243], Earth, 1.5, Thunder, 0.5, 0.3, 0.45, 0.2, 0.05, 0.55, 1),
		new Yokai("Tunatic", 295, A, Slippery, false, statA[317], statB[317], ListAttack[8], ListTechnique[8], "Fire Play", inspiritList[244], Water, 1.8, Earth, 0.5, 0.65, 0.15, 0.15, 0.05, 0.6, 1),
		new Yokai("Flushback", 296, D, Slippery, false, statA[318], statB[318], ListAttack[3], ListTechnique[7], "Windbreaker", inspiritList[245], Ice, 1.3, Water, 0.7, 0.1, 0.65, 0.15, 0.1, 0.45, 1),
		new Yokai("Vacuumory", 297, A, Slippery, false, statA[319], statB[319], ListAttack[1], ListTechnique[11], "Windbreaker", inspiritList[245], Earth, 1.5, Water, 0.5, 0.15, 0.65, 0.15, 0.05, 0.6, 1),
		new Yokai("Irewig", 298, D, Slippery, false, statA[320], statB[320], ListAttack[1], ListTechnique[4], "Revenge", inspiritList[246], Water, 1.3, Fire, 0.7, 0.6, 0.15, 0.15, 0.1, 0.45, 1),
		new Yokai("Firewig", 299, A, Slippery, false, statA[321], statB[321], ListAttack[7], ListTechnique[8], "Revenge", inspiritList[247], Water, 1.5, Fire, 0.5, 0.65, 0.15, 0.1, 0.1, 0.6, 1),
		new Yokai("Draggie", 300, D, Slippery, false, statA[322], statB[322], ListAttack[16], ListTechnique[16], "Hard Worker", inspiritList[248], Water, 1.3, Earth, 0.7, 0.2, 0.55, 0.2, 0.05, 0.45, 1),
		new Yokai("Dragon Lord", 301, S, Slippery, false, statA[323], statB[323], ListAttack[21], ListTechnique[10], "Dragon Force", inspiritList[248], Water, 1.5, Earth, 0.5, 0.15, 0.65, 0.15, 0.05, 0.65, 1),
		new Yokai("Azure Dragon", 302, S, Slippery, false, statA[324], statB[324], ListAttack[21], ListTechnique[22], "Dragon Force", inspiritList[249], Thunder, 1.8, Water, 0.5, 0.5, 0.35, 0.1, 0.05, 0.65, 1),
		new Yokai("Mermaidyn", 303, D, Slippery, false, statA[325], statB[325], ListAttack[45], ListTechnique[13], "Saintly Scales", inspiritList[250], Thunder, 1.5, Water, 0.5, 0.15, 0.65, 0.15, 0.05, 0.45, 1),
		new Yokai("Mermadonna", 304, S, Slippery, false, statA[326], statB[326], ListAttack[45], ListTechnique[22], "Saintly Scales", inspiritList[250], Thunder, 1.8, Water, 0.3, 0.2, 0.65, 0.1, 0.05, 0.65, 1),
		new Yokai("Mermother", 305, S, Slippery, false, statA[327], statB[327], ListAttack[45], ListTechnique[22], "Saintly Scales", inspiritList[34], Thunder, 1.8, Water, 0.2, 0.15, 0.7, 0.1, 0.05, 0.65, 1),
		new Yokai("Lady Longnek", 306, C, Slippery, false, statA[328], statB[328], ListAttack[17], ListTechnique[15], "Rubberneck", inspiritList[251], Earth, 1.5, Ice, 0.5, 0.45, 0.3, 0.2, 0.05, 0.5, 1),
		new Yokai("Daiz", 307, C, Slippery, false, statA[329], statB[329], ListAttack[3], ListTechnique[3], "Dodge", inspiritList[252], Neutral, 1.0, Earth, 0.8, 0.05, 0.7, 0.2, 0.05, 0.5, 1),
		new Yokai("Confuze", 308, B, Slippery, false, statA[330], statB[330], ListAttack[3], ListTechnique[3], "Dodge", inspiritList[253], Neutral, 1.0, Earth, 0.8, 0.2, 0.45, 0.3, 0.05, 0.55, 1),
		new Yokai("Chummer", 309, C, Slippery, false, statA[331], statB[331], ListAttack[21], ListTechnique[13], "Loiterer", inspiritList[254], Thunder, 1.3, Water, 0.7, 0.65, 0.15, 0.15, 0.05, 0.5, 1),
		new Yokai("Shrook", 310, B, Slippery, false, statA[332], statB[332], ListAttack[21], ListTechnique[13], "Shark Skin", inspiritList[255], Thunder, 1.5, Water, 0.5, 0.7, 0.1, 0.15, 0.05, 0.55, 1),
		new Yokai("Spenp", 311, C, Slippery, false, statA[333], statB[333], ListAttack[6], ListTechnique[19], "Matchless Shell", inspiritList[256], Ice, 1.3, Wind, 0.7, 0.4, 0.3, 0.1, 0.2, 0.5, 1),
		new Yokai("Almi", 312, B, Slippery, false, statA[334], statB[334], ListAttack[6], ListTechnique[13], "Matchless Shell", inspiritList[110], Thunder, 1.8, Water, 0.5, 0.2, 0.6, 0.05, 0.15, 0.55, 1),
		new Yokai("Babblong", 313, C, Slippery, false, statA[335], statB[335], ListAttack[12], ListTechnique[13], "Skilled Loafer", inspiritList[257], Thunder, 1.3, Water, 0.7, 0.55, 0.15, 0.25, 0.05, 0.5, 1),
		new Yokai("Bananose", 314, A, Slippery, false, statA[336], statB[336], ListAttack[12], ListTechnique[22], "Skilled Loafer", inspiritList[258], Thunder, 1.8, Water, 0.5, 0.6, 0.2, 0.15, 0.05, 0.6, 1),
		new Yokai("Draaagin", 315, B, Slippery, false, statA[337], statB[337], ListAttack[21], ListTechnique[2], "Just a Minute", inspiritList[259], Fire, 1.5, Ice, 0.5, 0.25, 0.45, 0.2, 0.1, 0.55, 2),
		new Yokai("SV Snaggerjag", 316, B, Slippery, false, statA[338], statB[338], ListAttack[1], ListTechnique[22], "Waterworks", inspiritList[260], Thunder, 1.5, Water, 0.3, 0.25, 0.65, 0.05, 0.05, 0.55, 1),
		new Yokai("Copperled", 317, B, Slippery, false, statA[339], statB[339], ListAttack[0], ListTechnique[1], "Fire Watchout", inspiritList[261], Water, 1.5, Fire, 0.5, 0.55, 0.2, 0.2, 0.05, 0.55, 1),
		new Yokai("Cynake", 318, B, Slippery, false, statA[340], statB[340], ListAttack[0], ListTechnique[13], "Greed", inspiritList[262], Thunder, 1.5, Water, 0.5, 0.1, 0.65, 0.2, 0.05, 0.55, 1),
		new Yokai("Slitheref", 319, A, Slippery, false, statA[341], statB[341], ListAttack[0], ListTechnique[21], "Too Serious", inspiritList[263], Earth, 1.5, Thunder, 0.5, 0.4, 0.35, 0.2, 0.05, 0.6, 1),
		new Yokai("Venoct", 320, S, Slippery, false, statA[342], statB[342], ListAttack[21], ListTechnique[21], "Venocharge", inspiritList[264], Earth, 1.8, Thunder, 0.5, 0.55, 0.3, 0.1, 0.05, 0.65, 1),
		new Yokai("Shadow Venoct", 321, S, Slippery, false, statA[343], statB[343], ListAttack[21], ListTechnique[11], "Secrecy", inspiritList[265], Thunder, 1.5, Fire, 0.5, 0.3, 0.55, 0.1, 0.05, 0.65, 1),
		new Yokai("Shogunyan", 322, S, Brave, false, statA[344], statB[344], ListAttack[20], ListTechnique[18], "Extreme Critical", inspiritList[266], Ice, 1.8, Wind, 0.2, 0.7, 0.15, 0.1, 0.05, 0.9, 1),
		new Yokai("Komashura", 323, S, Mysterious, false, statA[345], statB[345], ListAttack[31], ListTechnique[8], "Blazing Spirit", inspiritList[267], Water, 1.8, Fire, 0.2, 0.1, 0.75, 0.1, 0.05, 0.9, 1),
		new Yokai("Gilgaros", 324, S, Tough, false, statA[346], statB[346], ListAttack[7], ListTechnique[9], "Extreme Critical", inspiritList[268], Earth, 1.8, Thunder, 0.2, 0.75, 0.05, 0.1, 0.1, 0.9, 1),
		new Yokai("Spoilerina", 325, S, Charming, false, statA[347], statB[347], ListAttack[38], ListTechnique[18], "Twinkle Toes", inspiritList[269], Ice, 1.8, Wind, 0.2, 0.05, 0.75, 0.15, 0.05, 0.9, 1),
		new Yokai("Elder Bloom", 326, S, Heartful, false, statA[348], statB[348], ListAttack[16], ListTechnique[11], "Caring", inspiritList[270], Wind, 1.8, Earth, 0.2, 0.05, 0.75, 0.15, 0.05, 0.9, 1),
		new Yokai("Poofessor", 327, S, Shady, false, statA[349], statB[349], ListAttack[29], ListTechnique[14], "Biochemistry", inspiritList[271], Wind, 1.8, Fire, 0.2, 0.35, 0.3, 0.3, 0.05, 0.9, 1),
		new Yokai("Dandoodle", 328, S, Eerie, false, statA[350], statB[350], ListAttack[44], ListTechnique[11], "Popularity", inspiritList[272], Thunder, 1.8, Water, 0.2, 0.1, 0.65, 0.2, 0.05, 0.9, 1),
		new Yokai("Slurpent", 329, S, Slippery, false, statA[351], statB[351], ListAttack[21], ListTechnique[14], "Tongue Twister", inspiritList[273], Water, 1.8, Fire, 0.2, 0.4, 0.4, 0.1, 0.1, 0.7, 1),
		new Yokai("Sapphinyan", 330, A, Charming, false, statA[352], statB[352], ListAttack[34], ListTechnique[22], "Linked Together", inspiritList[274], Thunder, 1.8, Water, 0.3, 0.3, 0.55, 0.1, 0.05, 0.8, 1),
		new Yokai("Emenyan", 331, A, Charming, false, statA[353], statB[353], ListAttack[34], ListTechnique[11], "Linked Together", inspiritList[275], Neutral, 1.0, Neutral, 1.0, 0.2, 0.6, 0.15, 0.05, 0.8, 1),
		new Yokai("Rubinyan", 332, A, Charming, false, statA[354], statB[354], ListAttack[34], ListTechnique[8], "Linked Together", inspiritList[276], Water, 1.8, Fire, 0.3, 0.65, 0.2, 0.1, 0.05, 0.8, 1),
		new Yokai("Topanyan", 333, A, Charming, false, statA[355], statB[355], ListAttack[34], ListTechnique[21], "Linked Together", inspiritList[277], Earth, 1.8, Thunder, 0.3, 0.6, 0.2, 0.05, 0.15, 0.8, 1),
		new Yokai("Dianyan", 334, A, Charming, false, statA[356], statB[356], ListAttack[34], ListTechnique[2], "Linked Together", inspiritList[278], Fire, 1.8, Ice, 0.3, 0.4, 0.35, 0.2, 0.05, 0.8, 1),
		new Yokai("Melonyan", 335, A, Charming, false, statA[357], statB[357], ListAttack[34], ListTechnique[5], "Juicy Goodness", inspiritList[279], Fire, 1.5, Ice, 0.3, 0.35, 0.35, 0.2, 0.1, 0.8, 1),
		new Yokai("Oranyan", 336, B, Charming, false, statA[358], statB[358], ListAttack[34], ListTechnique[9], "Juicy Goodness", inspiritList[280], Earth, 1.5, Thunder, 0.3, 0.45, 0.35, 0.15, 0.05, 0.8, 1),
		new Yokai("Kiwinyan", 337, B, Charming, false, statA[359], statB[359], ListAttack[34], ListTechnique[16], "Juicy Goodness", inspiritList[281], Wind, 1.5, Earth, 0.3, 0.6, 0.25, 0.1, 0.05, 0.8, 1),
		new Yokai("Grapenyan", 338, B, Charming, false, statA[360], statB[360], ListAttack[34], ListTechnique[13], "Juicy Goodness", inspiritList[282], Thunder, 1.5, Water, 0.3, 0.25, 0.6, 0.1, 0.05, 0.8, 1),
		new Yokai("Strawbnyan", 339, B, Charming, false, statA[361], statB[361], ListAttack[34], ListTechnique[1], "Juicy Goodness", inspiritList[283], Water, 1.5, Fire, 0.3, 0.35, 0.45, 0.15, 0.05, 0.8, 1),
		new Yokai("Watermelnyan", 340, A, Charming, false, statA[362], statB[362], ListAttack[34], ListTechnique[19], "Juicy Goodness", inspiritList[284], Ice, 1.5, Wind, 0.3, 0.5, 0.15, 0.2, 0.15, 0.8, 1),
		new Yokai("Robokapp", 341, A, Charming, false, statA[363], statB[363], ListAttack[32], ListTechnique[13], "Polarity", inspiritList[102], Thunder, 1.5, Water, 0.3, 0.3, 0.55, 0.05, 0.1, 0.8, 1),
		new Yokai("Robokoma", 342, A, Charming, false, statA[364], statB[364], ListAttack[32], ListTechnique[1], "Polarity", inspiritList[102], Thunder, 1.5, Fire, 0.3, 0.2, 0.65, 0.05, 0.1, 0.8, 1),
		new Yokai("Robogramps", 343, B, Heartful, false, statA[365], statB[365], ListAttack[16], ListTechnique[15], "Polarity", inspiritList[102], Thunder, 1.5, Ice, 0.3, 0.35, 0.5, 0.1, 0.05, 0.75, 1),
		new Yokai("Robomutt", 344, B, Eerie, false, statA[366], statB[366], ListAttack[6], ListTechnique[19], "Polarity", inspiritList[102], Thunder, 1.5, Earth, 0.5, 0.6, 0.15, 0.15, 0.1, 0.75, 1),
		new Yokai("Robonoko", 345, B, Slippery, false, statA[367], statB[367], ListAttack[2], ListTechnique[16], "Polarity", inspiritList[102], Thunder, 1.5, Earth, 0.3, 0.05, 0.75, 0.05, 0.15, 0.55, 1),
		new Yokai("Robodraggie", 346, B, Slippery, false, statA[368], statB[368], ListAttack[16], ListTechnique[1], "Polarity", inspiritList[102], Thunder, 1.5, Fire, 0.3, 0.1, 0.7, 0.1, 0.1, 0.55, 1),
		new Yokai("Wondernyan", 347, B, Charming, false, statA[369], statB[369], ListAttack[20], ListTechnique[0], "Long Lasting", inspiritList[64], Thunder, 1.3, Ice, 0.5, 0.6, 0.25, 0.1, 0.05, 0.8, 1),
		new Yokai("Robonyan F", 348, A, Tough, false, statA[370], statB[370], ListAttack[33], ListTechnique[1], "Polarity", inspiritList[285], Water, 1.3, Fire, 0.5, 0.8, 0.05, 0.05, 0.1, 0.85, 1),
		new Yokai("Sailornyan", 349, A, Charming, false, statA[371], statB[371], ListAttack[34], ListTechnique[11], "Healer Moon", inspiritList[286], Fire, 1.3, Ice, 0.5, 0.15, 0.65, 0.15, 0.05, 0.8, 1),
		new Yokai("Machonyan", 350, A, Brave, false, statA[372], statB[372], ListAttack[34], ListTechnique[17], "Purrsistence", inspiritList[124], Earth, 1.3, Thunder, 0.5, 0.7, 0.15, 0.1, 0.05, 0.85, 1),
		new Yokai("Hovernyan", 351, B, Brave, false, statA[373], statB[373], ListAttack[34], ListTechnique[19], "Acrobat", inspiritList[287], Ice, 1.5, Wind, 0.3, 0.65, 0.2, 0.1, 0.05, 0.8, 1),
		new Yokai("Darknyan", 352, A, Eerie, false, statA[374], statB[374], ListAttack[34], ListTechnique[18], "Night Guard", inspiritList[133], Ice, 1.5, Wind, 0.3, 0.2, 0.45, 0.3, 0.05, 0.8, 1),
		new Yokai("Jibakoma", 353, A, Charming, false, statA[375], statB[375], ListAttack[32], ListTechnique[8], "Fire Play", inspiritList[120], Water, 1.3, Fire, 0.5, 0.1, 0.7, 0.15, 0.05, 0.8, 1),
		new Yokai("Jetnyan", 354, B, Charming, false, statA[376], statB[376], ListAttack[34], ListTechnique[18], "Number One!", inspiritList[288], Ice, 1.3, Wind, 0.5, 0.1, 0.65, 0.2, 0.05, 0.8, 1),
		new Yokai("Unfairy", 355, S, Wicked, false, statA[377], statB[377], ListAttack[34], ListTechnique[14], "Grip on You", inspiritList[289], Water, 1.5, Fire, 0.3, 0.05, 0.75, 0.1, 0.1, 0.35, 0),
		new Yokai("Unkaind", 356, S, Wicked, false, statA[378], statB[378], ListAttack[38], ListTechnique[22], "Curse Worsener", inspiritList[290], Thunder, 1.5, Water, 0.3, 0.3, 0.5, 0.15, 0.05, 0.35, 0),
		new Yokai("Untidy", 357, S, Wicked, false, statA[379], statB[379], ListAttack[4], ListTechnique[10], "Extreme Critical", inspiritList[291], Wind, 1.5, Earth, 0.3, 0.8, 0.05, 0.1, 0.05, 0.35, 0),
		new Yokai("Unpleasant", 358, S, Wicked, false, statA[380], statB[380], ListAttack[1], ListTechnique[18], "Soothing Rhythm", inspiritList[292], Ice, 1.5, Wind, 0.3, 0.05, 0.8, 0.1, 0.05, 0.35, 0),
		new Yokai("Unkeen", 359, S, Wicked, false, statA[381], statB[381], ListAttack[31], ListTechnique[21], "Guard Break", inspiritList[293], Earth, 1.5, Thunder, 0.3, 0.45, 0.4, 0.1, 0.05, 0.1, 0),
		new Yokai("Grublappa", 360, C, Wicked, false, statA[382], statB[382], ListAttack[37], ListTechnique[9], "Lickaway", inspiritList[13], Earth, 1.5, Thunder, 0.5, 0.85, 0.05, 0.05, 0.05, 0.2, 0),
		new Yokai("Madmunch", 361, B, Wicked, false, statA[383], statB[383], ListAttack[30], ListTechnique[16], "Sludge Grudge", inspiritList[19], Wind, 1.8, Earth, 0.3, 0.8, 0.1, 0.05, 0.05, 0.25, 0),
		new Yokai("Badsmella", 362, A, Wicked, false, statA[384], statB[384], ListAttack[38], ListTechnique[18], "Magic Mist", inspiritList[294], Ice, 1.5, Wind, 0.5, 0.05, 0.8, 0.1, 0.05, 0.3, 0),
		new Yokai("Mad Kappa", 363, A, Wicked, false, statA[385], statB[385], ListAttack[25], ListTechnique[22], "Intimidation", inspiritList[295], Thunder, 2.0, Water, 0.2, 0.3, 0.6, 0.05, 0.05, 0.3, 0),
		new Yokai("Shamasol", 364, D, Wicked, false, statA[386], statB[386], ListAttack[27], ListTechnique[19], "Sun Shield", inspiritList[296], Ice, 1.5, Wind, 0.5, 0.05, 0.45, 0.45, 0.05, 0.15, 0),
		new Yokai("Gnomine", 365, C, Wicked, false, statA[387], statB[387], ListAttack[17], ListTechnique[15], "Good Fortune", inspiritList[297], Fire, 1.5, Earth, 0.5, 0.1, 0.8, 0.05, 0.05, 0.25, 0),
		new Yokai("Defectabull", 366, C, Wicked, false, statA[388], statB[388], ListAttack[3], ListTechnique[15], "Clairvoidance", inspiritList[298], Water, 1.5, Earth, 0.5, 0.5, 0.4, 0.05, 0.05, 0.25, 0),
		new Yokai("Feargus", 367, D, Wicked, false, statA[389], statB[389], ListAttack[45], ListTechnique[16], "Hairnet", inspiritList[216], Wind, 1.5, Earth, 0.5, 0.05, 0.4, 0.5, 0.05, 0.15, 0),
		new Yokai("Scaremaiden", 368, C, Wicked, false, statA[390], statB[390], ListAttack[45], ListTechnique[13], "Saintly Scales", inspiritList[299], Thunder, 1.8, Water, 0.3, 0.05, 0.85, 0.05, 0.05, 0.2, 0),
		new Yokai("Wrongnek", 369, B, Wicked, false, statA[391], statB[391], ListAttack[17], ListTechnique[15], "Rubberneck", inspiritList[300], Earth, 1.8, Ice, 0.3, 0.5, 0.4, 0.05, 0.05, 0.25, 1),
		new Yokai("Grumpus Khan", 370, D, Shady, false, statA[392], statB[392], ListAttack[2], ListTechnique[23], "Breaking Baaad", inspiritList[301], Ice, 1.3, Wind, 0.5, 0.5, 0.2, 0.25, 0.05, 0.6, 1),
		new Yokai("Groupus Khan", 371, B, Shady, false, statA[393], statB[393], ListAttack[5], ListTechnique[19], "Breaking Baaad", inspiritList[301], Ice, 1.5, Wind, 0.3, 0.55, 0.1, 0.3, 0.05, 0.65, 1),
		new Yokai("Slumberhog", 372, D, Brave, false, statA[394], statB[394], ListAttack[3], ListTechnique[4], "Fast Asleep", inspiritList[125], Water, 1.3, Fire, 0.5, 0.5, 0.2, 0.2, 0.1, 0.75, 2),
		new Yokai("Snortlehog", 373, B, Brave, false, statA[395], statB[395], ListAttack[8], ListTechnique[1], "Extreme Critical", inspiritList[302], Water, 1.5, Fire, 0.3, 0.65, 0.15, 0.15, 0.05, 0.8, 1),
		new Yokai("Panja Pupil", 374, D, Charming, false, statA[396], statB[396], ListAttack[17], ListTechnique[6], "Secrecy", inspiritList[303], Fire, 1.3, Ice, 0.5, 0.6, 0.15, 0.2, 0.05, 0.7, 1),
		new Yokai("Panja Pro", 375, B, Charming, false, statA[397], statB[397], ListAttack[8], ListTechnique[5], "Secrecy", inspiritList[303], Fire, 1.5, Ice, 0.3, 0.7, 0.15, 0.1, 0.05, 0.8, 1),
		new Yokai("Samureel", 376, D, Brave, false, statA[398], statB[398], ListAttack[1], ListTechnique[20], "Skilled Loafer", inspiritList[304], Thunder, 1.3, Water, 0.5, 0.6, 0.1, 0.1, 0.2, 0.75, 1),
		new Yokai("Time Keeler", 377, B, Brave, false, statA[399], statB[399], ListAttack[20], ListTechnique[13], "Skilled Loafer", inspiritList[304], Thunder, 1.5, Water, 0.3, 0.7, 0.05, 0.05, 0.2, 0.8, 1),
	};
}

private static Yokai[] medaillum_4() {
	return new Yokai[] {
		new Yokai("Takoyakid", 378, D, Slippery, false, statA[400], statB[400], ListAttack[29], ListTechnique[4], "Killer Comeback", inspiritList[305], Water, 1.3, Fire, 0.5, 0.6, 0.15, 0.15, 0.1, 0.45, 1),
		new Yokai("Takoyaking", 379, B, Slippery, false, statA[401], statB[401], ListAttack[41], ListTechnique[1], "Killer Comeback", inspiritList[305], Water, 1.5, Fire, 0.3, 0.65, 0.15, 0.1, 0.1, 0.55, 1),
		new Yokai("Danke Sand", 380, D, Eerie, false, statA[402], statB[402], ListAttack[30], ListTechnique[12], "Sandbag", inspiritList[306], Wind, 1.3, Earth, 0.5, 0.05, 0.35, 0.5, 0.1, 0.65, 1),
		new Yokai("No Sandkyu", 381, B, Eerie, false, statA[403], statB[403], ListAttack[31], ListTechnique[16], "Sandbag", inspiritList[81], Wind, 1.5, Earth, 0.3, 0.05, 0.35, 0.5, 0.1, 0.75, 1),
		new Yokai("Sumodon", 382, D, Tough, false, statA[404], statB[404], ListAttack[26], ListTechnique[7], "The Stand", inspiritList[307], Thunder, 1.3, Water, 0.5, 0.6, 0.1, 0.2, 0.1, 0.75, 1),
		new Yokai("Yokozudon", 383, B, Tough, false, statA[405], statB[405], ListAttack[26], ListTechnique[15], "The Stand", inspiritList[307], Thunder, 1.5, Water, 0.3, 0.65, 0.1, 0.1, 0.15, 0.85, 1),
		new Yokai("Whateverest", 384, D, Tough, false, statA[406], statB[406], ListAttack[3], ListTechnique[4], "Eruption", inspiritList[308], Water, 1.5, Fire, 0.3, 0.05, 0.6, 0.15, 0.2, 0.75, 1),
		new Yokai("Whatuption", 385, B, Tough, false, statA[407], statB[407], ListAttack[44], ListTechnique[1], "Eruption", inspiritList[309], Water, 1.8, Fire, 0.2, 0.05, 0.6, 0.1, 0.25, 0.85, 1),
		new Yokai("Happycane", 386, D, Heartful, false, statA[408], statB[408], ListAttack[3], ListTechnique[7], "How Sweet", inspiritList[310], Ice, 1.3, Wind, 0.5, 0.1, 0.65, 0.2, 0.05, 0.65, 1),
		new Yokai("Starrycane", 387, B, Heartful, false, statA[409], statB[409], ListAttack[44], ListTechnique[15], "How Sweet", inspiritList[310], Ice, 1.5, Wind, 0.3, 0.1, 0.7, 0.15, 0.05, 0.75, 1),
		new Yokai("Snottle", 430, D, Mysterious, false, statA[410], statB[410], ListAttack[28], ListTechnique[3], "He Just Nose", inspiritList[311], Neutral, 1.0, Neutral, 1.0, 0.05, 0.2, 0.7, 0.05, 0.7, 1),
		new Yokai("Moximous N", 431, B, Brave, false, statA[411], statB[411], ListAttack[31], ListTechnique[18], "Born Winner", inspiritList[312], Water, 1.5, Fire, 0.3, 0.7, 0.15, 0.1, 0.05, 0.8, 1),
		new Yokai("Moximous K", 432, B, Brave, false, statA[412], statB[412], ListAttack[31], ListTechnique[22], "Born Lucky", inspiritList[312], Thunder, 1.8, Water, 0.3, 0.15, 0.7, 0.1, 0.05, 0.8, 1),
		new Yokai("Jibanyan S", 433, S, Charming, false, statA[413], statB[413], ListAttack[34], ListTechnique[1], "All or Nothing", inspiritList[313], Water, 1.5, Fire, 0.2, 0.7, 0.15, 0.1, 0.05, 0.7, 1),
		new Yokai("Komasan S", 434, S, Charming, false, statA[414], statB[414], ListAttack[30], ListTechnique[8], "Firewall", inspiritList[314], Water, 1.8, Fire, 0.1, 0.15, 0.7, 0.1, 0.05, 0.85, 1),
		new Yokai("Komajiro S", 435, S, Charming, false, statA[415], statB[415], ListAttack[31], ListTechnique[21], "Superconductor", inspiritList[315], Earth, 2.0, Thunder, 0.1, 0.15, 0.7, 0.1, 0.05, 0.85, 1),
		new Yokai("Darkyubi", 436, S, Shady, false, statA[416], statB[416], ListAttack[45], ListTechnique[14], "Darkness Falls", inspiritList[316], Ice, 1.5, Thunder, 0.7, 0.05, 0.55, 0.35, 0.05, 0.75, 1),
		new Yokai("Illuminoct", 437, S, Brave, false, statA[417], statB[417], ListAttack[21], ListTechnique[21], "Lord of Light", inspiritList[317], Earth, 1.5, Thunder, 0.5, 0.65, 0.2, 0.1, 0.05, 0.9, 1),
		new Yokai("Gargaros", 438, S, Tough, false, statA[418], statB[418], ListAttack[7], ListTechnique[8], "Guard Break", inspiritList[268], Water, 1.5, Fire, 0.5, 0.7, 0.1, 0.1, 0.1, 0.9, 1),
		new Yokai("Ogralus", 439, S, Tough, false, statA[419], statB[419], ListAttack[7], ListTechnique[22], "Water Play", inspiritList[268], Thunder, 1.5, Water, 0.5, 0.1, 0.7, 0.1, 0.1, 0.9, 1),
		new Yokai("Orcanos", 440, S, Tough, false, statA[420], statB[420], ListAttack[7], ListTechnique[14], "Thick Crust", inspiritList[268], Wind, 1.5, Fire, 0.7, 0.7, 0.1, 0.1, 0.1, 0.9, 1),
	};
}

public static Yokai[] medaillum = mergeYokai(medaillum_0(), medaillum_1(), medaillum_2(), medaillum_3(), medaillum_4());
